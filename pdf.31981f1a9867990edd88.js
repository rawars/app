        ...
        99299: function(module, exports) {
            ...
            root = this, factory = function() {
                return function(e) {
                    ...
                    }, t.stringToBytes = d, t.stringToPDFString = function(e) {
                        const t = e.length,
                            r = [];
                        if ("þ" === e[0] && "ÿ" === e[1])
                            for (let s = 2; s < t; s += 2) r.push(String.fromCharCode(e.charCodeAt(s) << 8 | e.charCodeAt(s + 1)));
                        else if ("ÿ" === e[0] && "þ" === e[1])
                            for (let s = 2; s < t; s += 2) r.push(String.fromCharCode(e.charCodeAt(s + 1) << 8 | e.charCodeAt(s)));
                        else
                            for (let s = 0; s < t; ++s) {
                                const t = A[e.charCodeAt(s)];
                    ...
                    t.VerbosityLevel = s, t.CMapCompressionType = {
                        NONE: 0,
                        BINARY: 1,
                        STREAM: 2
                    }, t.OPS = {
                    ...
                    function u(e) {
                        return void 0 !== e.length ? e.length : (o(void 0 !== e.byteLength), e.byteLength)
                    }
                    const p = {
                        get value() {
                    ...
                    class m {
                        static makeCssRgb(e, t, r) {
                            return f[1] = e, f[3] = t, f[5] = r, f.join("")
                        }
                        ...
                        static getAxialAlignedBoundingBox(e, t) {
                            const r = m.applyTransform(e, t),
                                s = m.applyTransform(e.slice(2, 4), t),
                                n = m.applyTransform([e[0], e[3]], t),
                                i = m.applyTransform([e[2], e[1]], t);
                            return [Math.min(r[0], s[0], n[0], i[0]), Math.min(r[1], s[1], n[1], i[1]), Math.max(r[0], s[0], n[0], i[0]), Math.max(r[1], s[1], n[1], i[1])]
                        }
                        ...
                        static singularValueDecompose2dScale(e) {
                            const t = [e[0], e[2], e[1], e[3]],
                                ...
                                i = e[2] * t[1] + e[3] * t[3],
                                a = (r + i) / 2,
                                o = Math.sqrt((r + i) * (r + i) - 4 * (r * i - n * s)) / 2,
                                l = a + o || 1,
                                c = a - o || 1;
                        ...
                        static intersect(e, t) {
                            ...
                            const s = [e[0], e[2], t[0], t[2]].sort(r),
                                n = [e[1], e[3], t[1], t[3]].sort(r),
                                i = [];
                            return e = m.normalizeRect(e), t = m.normalizeRect(t), s[0] === e[0] && s[1] === t[0] || s[0] === t[0] && s[1] === e[0] ? (i[0] = s[1], i[2] = s[2], n[0] === e[1] && n[1] === t[1] || n[0] === t[1] && n[1] === e[1] ? (i[1] = n[1], i[3] = n[2], i) : null) : null
                        }
                    }
                    t.Util = m;
                            ...
                            return function(t, r, s = !1) {
                                ...
                                for (let r = 0, s = t.length; r < s; r += 3) {
                                    const i = 255 & t[r],
                                        a = 255 & t[r + 1],
                                        o = 255 & t[r + 2];
                                    n += e[i >> 2] + e[(3 & i) << 4 | a >> 4] + e[r + 1 < s ? (15 & a) << 2 | o >> 6 : 64] + e[r + 2 < s ? 63 & o : 64]
                                }
                                return n
                            }
                        }();
                    t.createObjectURL = b
                }, function(e, t, r) {}, function(module, exports, __w_pdfjs_require__) {
                    "use strict";
                    ...
                    var _util = __w_pdfjs_require__(1),
                        _display_utils = __w_pdfjs_require__(4),
                        _font_loader = __w_pdfjs_require__(5),
                        _api_compatibility = __w_pdfjs_require__(6),
                    ...
                    function getDocument(e) {
                        ...
                        for (const e in r)
                            if ("url" !== e || "undefined" == typeof window)
                                if ("range" !== e)
                                    if ("worker" !== e)
                                        if ("data" !== e || r[e] instanceof Uint8Array) s[e] = r[e];
                                        else {
                                            const t = r[e];
                                            if ("string" == typeof t) s[e] = (0, _util.stringToBytes)(t);
                        ...
                        return i.promise.then((function() {
                            ...
                            return _fetchDocument(i, s, n, o).then((function(e) {
                                if (t.destroyed) throw new Error("Loading aborted");
                                let r;
                                n ? r = new _transport_stream.PDFDataTransportStream({
                                    length: s.length,
                                    initialData: s.initialData,
                                    progressiveDone: s.progressiveDone,
                                    disableRange: s.disableRange,
                                    disableStream: s.disableStream
                                }, n) : s.data || (r = createPDFNetworkStream({
                                    url: s.url,
                                    length: s.length,
                                ...
                                const a = new _message_handler.MessageHandler(o, e, i.port);
                                a.postMessageTransfers = i.postMessageTransfers;
                                const l = new WorkerTransport(a, t, r, s);
                                t._transport = l, a.send("Ready", null)
                            }))
                    ...
                    class PDFPageProxy {
                        constructor(e, t, r, s = !1) {
                            this._pageIndex = e, this._pageInfo = t, this._transport = r, this._stats = s ? new _display_utils.StatTimer : null, this._pdfBug = s, this.commonObjs = r.commonObjs, this.objs = new PDFObjects, this.cleanupAfterRender = !1, this.pendingCleanup = !1, this.intentStates = Object.create(null), this.destroyed = !1
                        }
                        get pageNumber() {
                        ...
                        render({
                            ...
                            const d = o || new _display_utils.DOMCanvasFactory,
                                u = new _webgl.WebGLContext({
                                    enable: s
                                });
                            h.displayReadyCapability || (h.displayReadyCapability = (0, _util.createPromiseCapability)(), h.operatorList = {
                                ...
                                intent: c,
                                renderInteractiveForms: !0 === n
                            }));
                            const p = e => {
                                    const t = h.renderTasks.indexOf(g);
                                    t >= 0 && h.renderTasks.splice(t, 1), (this.cleanupAfterRender || "print" === c) && (this.pendingCleanup = !0), this._tryCleanup(), e ? (g.capability.reject(e), this._abortOperatorList({
                                        intentState: h,
                                        reason: e
                                    })) : g.capability.resolve(), this._stats && (this._stats.timeEnd("Rendering"), this._stats.timeEnd("Overall"))
                                },
                            ...
                            return h.displayReadyCapability.promise.then((e => {
                                this.pendingCleanup ? p() : (this._stats && this._stats.time("Rendering"), g.initializeGraphics(e), g.operatorListChanged())
                            })).catch(p), f
                        }
                        getOperatorList() {
                            const e = "oplist";
                            ...
                            return new Promise((function(e, r) {
                                ...
                                ! function t() {
                                    s.read().then((function({
                                        ...
                                        s ? e(n) : (Object.assign(n.styles, r.styles), n.items.push(...r.items), t())
                                    }), r)
                                }()
                            }))
                        }
                        ...
                        _renderPageChunk(e, t) {
                            for (let r = 0, s = e.length; r < s; r++) t.operatorList.fnArray.push(e.fnArray[r]), t.operatorList.argsArray.push(e.argsArray[r]);
                        ...
                        _pumpOperatorList(e) {
                            ...
                            const s = () => {
                                t.read().then((({
                                    ...
                                    t ? r.streamReader = null : this._transport.destroyed || (this._renderPageChunk(e, r), s())
                                }), (e => {
                            ...
                            const r = new WeakMap,
                                s = {
                                    data: function e(s) {
                                        ...
                                        let n, i;
                                        if ((n = s.buffer) && (0, _util.isArrayBuffer)(n)) return i = t && t.includes(n) ? new s.constructor(n, s.byteOffset, s.byteLength) : new s.constructor(s), r.set(s, i), i;
                                        i = Array.isArray(s) ? [] : {}, r.set(s, i);
                                        for (const t in s) {
                                            let r, n = s;
                                            for (; !(r = Object.getOwnPropertyDescriptor(n, t));) n = Object.getPrototypeOf(n);
                                            if (void 0 !== r.value)
                                                if ("function" != typeof r.value) i[t] = e(r.value);
                                                else if (s.hasOwnProperty && s.hasOwnProperty(t)) throw new Error(`LoopbackPort.postMessage - cannot clone: ${s[t]}`)
                                        }
                                        return i
                                    }(e)
                                };
                                ...
                                if ("undefined" != typeof Worker && !isWorkerDisabled && !getMainThreadWorkerMessageHandler()) {
                                    ...
                                    try {
                                        ...
                                        const t = new Worker(e),
                                            ...
                                            s = () => {
                                                t.removeEventListener("error", n), r.destroy(), t.terminate(), this.destroyed ? this._readyCapability.reject(new Error("Worker was destroyed")) : this._setupFakeWorker()
                                            },
                                            n = () => {
                                                this._webWorker || s()
                                            };
                                        t.addEventListener("error", n), r.on("test", (e => {
                                            t.removeEventListener("error", n), this.destroyed ? s() : e ? (this._messageHandler = r, this._port = t, this._webWorker = t, e.supportTransfers || (this.postMessageTransfers = !1), this._readyCapability.resolve(), r.send("configure", {
                                                verbosity: this.verbosity
                                            })) : (this._setupFakeWorker(), r.destroy(), t.terminate())
                                        })), r.on("ready", (e => {
                                            if (t.removeEventListener("error", n), this.destroyed) s();
                                            else try {
                                                i()
                                            } catch (e) {
                    ...
                    class WorkerTransport {
                        constructor(e, t, r, s) {
                            ...
                            }), this._params = s, this.CMapReaderFactory = new s.CMapReaderFactory({
                                baseUrl: s.cMapUrl,
                        ...
                        setupMessageHandler() {
                            ...
                            e.on("GetReader", ((e, t) => {
                                (0, _util.assert)(this._networkStream), this._fullReader = this._networkStream.getFullReader(), this._fullReader.onProgress = e => {
                                    this._lastProgress = {
                                        loaded: e.loaded,
                                        total: e.total
                                    }
                                    ...
                                    this._fullReader.read().then((function({
                                        ...
                                        r ? t.close() : ((0, _util.assert)((0, _util.isArrayBuffer)(e)), t.enqueue(new Uint8Array(e), 1, [e]))
                                    })).catch((e => {
                                        t.error(e)
                                    }))
                                }, t.onCancel = e => {
                                ...
                                return s.headersReady.then((() => {
                                    s.isStreamingSupported && s.isRangeSupported || (this._lastProgress && t.onProgress && t.onProgress(this._lastProgress), s.onProgress = e => {
                                ...
                                const [r, s, n] = t;
                                if (!this.commonObjs.has(r)) switch (s) {
                                    case "Font":
                                    ...
                                    case "JpegStream":
                                        return new Promise(((e, t) => {
                                            ...
                                            r.onload = function() {
                                                ...
                                                t(new Error("Error during JPEG image loading")), (0, _display_utils.releaseImageResources)(r)
                                            }, r.src = n
                                        })).then((e => {
                                            i.objs.resolve(t, e)
                                        }));
                            ...
                            })), e.on("UnsupportedFeature", this._onUnsupportedFeature.bind(this)), e.on("JpegDecode", (e => {
                                ...
                                const [t, r] = e;
                                return 3 !== r && 1 !== r ? Promise.reject(new Error("Only 3 components or 1 component can be returned")) : new Promise((function(e, s) {
                                    const n = new Image;
                                    n.onload = function() {
                                        const {
                                            width: t,
                                            height: s
                                        } = n, i = t * s, a = 4 * i, o = new Uint8ClampedArray(i * r);
                                        let l = document.createElement("canvas");
                                        l.width = t, l.height = s;
                                        let c = l.getContext("2d");
                                        c.drawImage(n, 0, 0);
                                        const h = c.getImageData(0, 0, t, s).data;
                                        if (3 === r)
                                            for (let e = 0, t = 0; e < a; e += 4, t += 3) o[t] = h[e], o[t + 1] = h[e + 1], o[t + 2] = h[e + 2];
                                        else if (1 === r)
                                            for (let e = 0, t = 0; e < a; e += 4, t++) o[t] = h[e];
                                        e({
                                            data: o,
                                            width: t,
                                            height: s
                                        }), (0, _display_utils.releaseImageResources)(n), l.width = 0, l.height = 0, l = null, c = null
                                    }, n.onerror = function() {
                                        s(new Error("JpegDecode failed to load image")), (0, _display_utils.releaseImageResources)(n)
                                    }, n.src = t
                                }))
                    ...
                    class PDFObjects {
                        ...
                        clear() {
                            for (const e in this._objs) {
                                const {
                                    data: t
                                } = this._objs[e];
                                "undefined" != typeof Image && t instanceof Image && (0, _display_utils.releaseImageResources)(t)
                            }
                            this._objs = Object.create(null)
                        }
                    }
                    ...
                    Object.defineProperty(t, "__esModule", {
                        ...
                        e.target = c, e.rel = "string" == typeof i ? i : n
                        ...
                        return new Promise(((t, r) => {
                            ...
                            s.src = e, s.onload = t, s.onerror = function() {
                        ...
                        (0, s.assert)(e instanceof Image, "Invalid `img` parameter.");
                        const t = e.src;
                        "string" == typeof t && t.startsWith("blob:") && URL.revokeObjectURL && URL.revokeObjectURL(t), e.removeAttribute("src")
                    ...
                    t.DOMCanvasFactory = class {
                        ...
                        async fetch({
                            ...
                            return c() && h(t, document.baseURI) ? fetch(t).then((async e => {
                                ...
                                let t;
                                return t = this.isCompressed ? new Uint8Array(await e.arrayBuffer()) : (0, s.stringToBytes)(await e.text()), {
                                    cMapData: t,
                                    compressionType: r
                                }
                            })).catch((e => {
                                ...
                                i.open("GET", t, !0), this.isCompressed && (i.responseType = "arraybuffer"), i.onreadystatechange = () => {
                                    if (i.readyState === XMLHttpRequest.DONE) {
                                        if (200 === i.status || 0 === i.status) {
                                            let t;
                                            if (this.isCompressed && i.response ? t = new Uint8Array(i.response) : !this.isCompressed && i.responseText && (t = (0, s.stringToBytes)(i.responseText)), t) return void e({
                                                cMapData: t,
                                                compressionType: r
                                            })
                                        }
                        ...
                        create(e, t) {
                            (0, s.assert)(e > 0 && t > 0, "Invalid SVG dimensions");
                        ...
                        createElement(e) {
                            return (0, s.assert)("string" == typeof e, "Invalid SVG element type"), document.createElementNS(i, e)
                        }
                    };
                    class a {
                        constructor({
                            ...
                            this.viewBox = e, this.scale = t, this.rotation = r, this.offsetX = s, this.offsetY = n;
                            const a = (e[2] + e[0]) / 2,
                                o = (e[3] + e[1]) / 2;
                            let l, c, h, d, u, p, g, f;
                            ...
                            i && (h = -h, d = -d), 0 === l ? (u = Math.abs(o - e[1]) * t + s, p = Math.abs(a - e[0]) * t + n, g = Math.abs(e[3] - e[1]) * t, f = Math.abs(e[2] - e[0]) * t) : (u = Math.abs(a - e[0]) * t + s, p = Math.abs(o - e[1]) * t + n, g = Math.abs(e[2] - e[0]) * t, f = Math.abs(e[3] - e[1]) * t), this.transform = [l * t, c * t, h * t, d * t, u - l * t * a - h * t * o, p - c * t * a - d * t * o], this.width = g, this.height = f
                        }
                        clone({
                            scale: e = this.scale,
                    ...
                    t.PageViewport = a;
                    class o extends s.BaseException {
                        constructor(e, t) {
                            super(e), this.type = t
                        }
                    }
                    ...
                    t.LinkTarget = l, t.StatTimer = class {
                        ...
                        time(e) {
                            e in this.started && (0, s.warn)(`Timer is already running for ${e}`), this.started[e] = Date.now()
                        }
                        timeEnd(e) {
                            e in this.started || (0, s.warn)(`Timer has not been started for ${e}`), this.times.push({
                                name: e,
                        ...
                        static toDateObject(e) {
                            ...
                            return u = u >= 0 && u <= 59 ? u : 0, "-" === c ? (a += h, o += u) : "+" === c && (a -= h, o -= u), new Date(Date.UTC(r, n, i, a, o, l))
                        }
                    }
                }, function(e, t, r) {
                    "use strict";
                    ...
                    class n {
                        constructor({
                            ...
                            this.constructor === n && (0, s.unreachable)("Cannot initialize BaseFontLoader."), this.docId = e, this._onUnsupportedFeature = t, this.nativeFontFaces = [], this.styleElement = null
                        }
                        addNativeFontFace(e) {
                                ...
                                if (t) {
                                    ...
                                    try {
                                        ...
                                        throw this._onUnsupportedFeature({
                                            featureId: s.UNSUPPORTED_FEATURES.font
                                        }), (0, s.warn)(`Failed to load font '${t.family}': '${r}'.`), e.disableFontFace = !0, r
                                    }
                                }
                                return
                            }
                    ...
                    let i;
                    t.FontLoader = i, t.FontLoader = i = class extends n {
                        constructor(e) {
                        ...
                        _queueLoadingCallback(e) {
                            const t = this.loadingContext,
                                r = {
                                    ...
                                    complete: function() {
                                        for ((0, s.assert)(!r.done, "completeRequest() cannot be called twice."), r.done = !0; t.requests.length > 0 && t.requests[0].done;) {
                        ...
                        _prepareFontLoadEvent(e, t, r) {
                            ...
                            for (A.style.visibility = "hidden", A.style.width = A.style.height = "10px", A.style.position = "absolute", A.style.top = A.style.left = "0px", a = 0, o = m.length; a < o; ++a) {
                                const e = document.createElement("span");
                                e.textContent = "Hi", e.style.fontFamily = m[a], A.appendChild(e)
                            }
                            document.body.appendChild(A),
                                function e(t, r) {
                                    if (h++, h > 30) return (0, s.warn)("Load test font never loaded."), void r();
                        ...
                        constructor(e, {
                            ...
                            disableFontFace: r = !1,
                            ignoreErrors: s = !1,
                            onUnsupportedFeature: n = null,
                            fontRegistry: i = null
                        }) {
                            this.compiledGlyphs = Object.create(null);
                            for (const t in e) this[t] = e[t];
                            this.isEvalSupported = !1 !== t, this.disableFontFace = !0 === r, this.ignoreErrors = !0 === s, this._onUnsupportedFeature = n, this.fontRegistry = i
                        }
                        ...
                        createFontFaceRule() {
                            if (!this.data || this.disableFontFace) return null;
                            const e = (0, s.bytesToString)(new Uint8Array(this.data)),
                        ...
                        getPathGenerator(e, t) {
                            ...
                            try {
                                ...
                                return this._onUnsupportedFeature && this._onUnsupportedFeature({
                                    featureId: s.UNSUPPORTED_FEATURES.font
                                }), (0, s.warn)(`getPathGenerator - ignoring character: "${e}".`), this.compiledGlyphs[t] = function(e, t) {}
                            }
                            if (this.isEvalSupported && s.IsEvalSupportedCached.value) {
                                ...
                                return this.compiledGlyphs[t] = new Function("c", "size", s)
                            }
                            return this.compiledGlyphs[t] = function(e, t) {
                                for (let s = 0, i = r.length; s < i; s++) n = r[s], "scale" === n.cmd && (n.args = [t, -t]), e[n.cmd].apply(e, n.args)
                            }
                        }
                    }
                }, function(e, t, r) {
                    ...
                    const s = Object.create(null); {
                        const {
                            isNodeJS: e
                        } = r(7), t = "undefined" != typeof navigator && navigator.userAgent || "", n = /Trident/.test(t), i = /CriOS/.test(t);
                        (n || i) && (s.disableCreateObjectURL = !0), e && (s.disableFontFace = !0, s.nativeImageDecoderSupport = "none")
                    }
                    t.apiCompatibilityParams = Object.freeze(s)
                }, function(e, t, r) {
                    "use strict";
                    Object.defineProperty(t, "__esModule", {
                        value: !0
                    ...
                    function l(e) {
                        e.mozCurrentTransform || (e._originalSave = e.save, e._originalRestore = e.restore, e._originalRotate = e.rotate, e._originalScale = e.scale, e._originalTranslate = e.translate, e._originalTransform = e.transform, e._originalSetTransform = e.setTransform, e._transformMatrix = e._transformMatrix || [1, 0, 0, 1, 0, 0], e._transformStack = [], Object.defineProperty(e, "mozCurrentTransform", {
                            ...
                            get: function() {
                                var e = this._transformMatrix,
                                    ...
                                    o = t * n - r * s,
                                    l = r * s - t * n;
                                return [n / o, r / l, s / l, t / o, (n * i - s * a) / l, (r * i - t * a) / o]
                            }
                        }), e.save = function() {
                            var e = this._transformMatrix;
                        ...
                        }, e.transform = function(t, r, s, n, i, a) {
                            var o = this._transformMatrix;
                            this._transformMatrix = [o[0] * t + o[2] * r, o[1] * t + o[3] * r, o[0] * s + o[2] * n, o[1] * s + o[3] * n, o[0] * i + o[2] * a + o[4], o[1] * i + o[3] * a + o[5]], e._originalTransform(t, r, s, n, i, a)
                        }, e.setTransform = function(t, r, s, n, i, a) {
                            this._transformMatrix = [t, r, s, n, i, a], e._originalSetTransform(t, r, s, n, i, a)
                        }, e.rotate = function(e) {
                            var t = Math.cos(e),
                                r = Math.sin(e),
                                s = this._transformMatrix;
                            this._transformMatrix = [s[0] * t + s[2] * r, s[1] * t + s[3] * r, s[0] * -r + s[2] * t, s[1] * -r + s[3] * t, s[4], s[5]], this._originalRotate(e)
                        })
                    }
                    var c = function() {
                            function e(e) {
                            ...
                            return e.prototype = {
                                getCanvas: function(e, t, r, s) {
                                    var n;
                                    return void 0 !== this.cache[e] ? (n = this.cache[e], this.canvasFactory.reset(n, t, r), n.context.setTransform(1, 0, 0, 1, 0, 0)) : (n = this.canvasFactory.create(t, r), this.cache[e] = n), s && l(n.context), n
                                },
                                clear() {
                        ...
                        d = function() {
                            function e(e, t, r, s, n, i) {
                                this.ctx = e, this.current = new h, this.stateStack = [], this.pendingClip = null, this.pendingEOFill = !1, this.res = null, this.xobjs = null, this.commonObjs = t, this.objs = r, this.canvasFactory = s, this.webGLContext = n, this.imageLayer = i, this.groupStack = [], this.processingType3 = null, this.baseTransform = null, this.baseTransformStack = [], this.groupLevel = 0, this.smaskStack = [], this.smaskCounter = 0, this.tempSMask = null, this.cachedCanvases = new c(this.canvasFactory), e && l(e), this._cachedGetSinglePixelWidth = null
                            }

                            function t(e, t) {
                                if ("undefined" != typeof ImageData && t instanceof ImageData) e.putImageData(t, 0, 0);
                                else {
                                    var r, n, i, a, l, c = t.height,
                                        h = t.width,
                                        d = c % o,
                                        u = (c - d) / o,
                                        p = 0 === d ? u : u + 1,
                                        g = e.createImageData(h, o),
                                        f = 0,
                                        m = t.data,
                                        A = g.data;
                                    if (t.kind === s.ImageKind.GRAYSCALE_1BPP) {
                                        var b = m.byteLength,
                                            _ = new Uint32Array(A.buffer, 0, A.byteLength >> 2),
                                            y = _.length,
                                            v = h + 7 >> 3,
                                            S = 4294967295,
                                            x = s.IsLittleEndianCached.value ? 4278190080 : 255;
                                        for (n = 0; n < p; n++) {
                                            for (a = n < u ? o : d, r = 0, i = 0; i < a; i++) {
                                                for (var C = b - f, k = 0, w = C > v ? h : 8 * C - 7, R = -8 & w, P = 0, T = 0; k < R; k += 8) T = m[f++], _[r++] = 128 & T ? S : x, _[r++] = 64 & T ? S : x, _[r++] = 32 & T ? S : x, _[r++] = 16 & T ? S : x, _[r++] = 8 & T ? S : x, _[r++] = 4 & T ? S : x, _[r++] = 2 & T ? S : x, _[r++] = 1 & T ? S : x;
                                                for (; k < w; k++) 0 === P && (T = m[f++], P = 128), _[r++] = T & P ? S : x, P >>= 1
                                            }
                                            for (; r < y;) _[r++] = 0;
                                            e.putImageData(g, 0, n * o)
                                        }
                                    } else if (t.kind === s.ImageKind.RGBA_32BPP) {
                                        for (i = 0, l = h * o * 4, n = 0; n < u; n++) A.set(m.subarray(f, f + l)), f += l, e.putImageData(g, 0, i), i += o;
                                        n < p && (l = h * d * 4, A.set(m.subarray(f, f + l)), e.putImageData(g, 0, i))
                                    } else {
                                        if (t.kind !== s.ImageKind.RGB_24BPP) throw new Error(`bad image kind: ${t.kind}`);
                                        for (l = h * (a = o), n = 0; n < p; n++) {
                                            for (n >= u && (l = h * (a = d)), r = 0, i = l; i--;) A[r++] = m[f++], A[r++] = m[f++], A[r++] = m[f++], A[r++] = 255;
                                            e.putImageData(g, 0, n * o)
                                        }
                                    }
                                }
                            ...
                            function r(e, t) {
                                for (var r = t.height, s = t.width, n = r % o, i = (r - n) / o, a = 0 === n ? i : i + 1, l = e.createImageData(s, o), c = 0, h = t.data, d = l.data, u = 0; u < a; u++) {
                                    for (var p = u < i ? o : n, g = 3, f = 0; f < p; f++)
                                        for (var m = 0, A = 0; A < s; A++) {
                                            if (!m) {
                                                var b = h[c++];
                                                m = 128
                                            }
                                            d[g] = b & m ? 0 : 255, g += 4, m >>= 1
                                        }
                                    e.putImageData(l, 0, u * o)
                                }
                            }

                            function d(e, t) {
                                for (var r = ["strokeStyle", "fillStyle", "fillRule", "globalAlpha", "lineWidth", "lineCap", "lineJoin", "miterLimit", "globalCompositeOperation", "font"], s = 0, n = r.length; s < n; s++) {
                                    var i = r[s];
                                    void 0 !== e[i] && (t[i] = e[i])
                                }
                            ...
                            function p(e, t, r, s) {
                                for (var n = e.length, i = 3; i < n; i += 4) {
                                    ...
                                    if (0 === a) e[i - 3] = t, e[i - 2] = r, e[i - 1] = s;
                                        ...
                                        var o = 255 - a;
                                        e[i - 3] = e[i - 3] * a + t * o >> 8, e[i - 2] = e[i - 2] * a + r * o >> 8, e[i - 1] = e[i - 1] * a + s * o >> 8
                                    }
                                }
                            }

                            function g(e, t, r) {
                                for (var s = e.length, n = 3; n < s; n += 4) {
                                    var i = r ? r[e[n]] : e[n];
                                    t[n] = t[n] * i * .00392156862745098 | 0
                                }
                            }

                            function f(e, t, r) {
                                for (var s = e.length, n = 3; n < s; n += 4) {
                                    var i = 77 * e[n - 3] + 152 * e[n - 2] + 28 * e[n - 1];
                                    t[n] = r ? t[n] * r[i >> 8] >> 8 : t[n] * i >> 16
                                }
                            }
                            ...
                            function m(e, t, r, s) {
                                ...
                                if (!t.transferMap && s.isEnabled) {
                                    const i = s.composeSMask({
                                        layer: r.canvas,
                                        mask: n,
                                        properties: {
                                            subtype: t.subtype,
                                ...
                                }! function(e, t, r, s, n, i, a) {
                                    var o, l = !!i,
                                        c = l ? i[0] : 0,
                                        h = l ? i[1] : 0,
                                        d = l ? i[2] : 0;
                                    o = "Luminosity" === n ? f : g;
                                    for (var u = Math.min(s, Math.ceil(1048576 / r)), m = 0; m < s; m += u) {
                                        var A = Math.min(u, s - m),
                                            b = e.getImageData(0, m, r, A),
                                            _ = t.getImageData(0, m, r, A);
                                        l && p(b.data, c, h, d), o(b.data, _.data, a), e.putImageData(_, 0, m)
                                    }
                                }(i, r, n.width, n.height, t.subtype, a, t.transferMap), e.drawImage(n, 0, 0)
                            }
                            var A = ["butt", "round", "square"],
                                b = ["miter", "round", "bevel"],
                                _ = {},
                                y = {};
                            for (var v in e.prototype = {
                                    beginDrawing({
                                        transform: e,
                                        viewport: t,
                                        transparency: r = !1,
                                        ...
                                        if (this.ctx.save(), this.ctx.fillStyle = s || "rgb(255, 255, 255)", this.ctx.fillRect(0, 0, n, i), this.ctx.restore(), r) {
                                            var a = this.cachedCanvases.getCanvas("transparent", n, i, !0);
                                        ...
                                        this.ctx.save(), u(this.ctx), e && this.ctx.transform.apply(this.ctx, e), this.ctx.transform.apply(this.ctx, t.transform), this.baseTransform = this.ctx.mozCurrentTransform.slice(), this.imageLayer && this.imageLayer.beginLayout()
                                    },
                                    executeOperatorList: function(e, t, r, n) {
                                        var i = e.argsArray,
                                            ...
                                            l = i.length;
                                        if (l === o) return o;
                                        for (var c, h = l - o > 10 && "function" == typeof r, d = h ? Date.now() + 15 : 0, u = 0, p = this.commonObjs, g = this.objs;;) {
                                            if (void 0 !== n && o === n.nextBreakPoint) return n.breakIt(o, r), o;
                                    ...
                                    beginSMaskGroup: function() {
                                        ...
                                        this.ctx.save();
                                        var o = n.context;
                                        o.scale(1 / e.scaleX, 1 / e.scaleY), o.translate(-e.offsetX, -e.offsetY), o.transform.apply(o, a), e.startTransformInverse = o.mozCurrentTransformInverse, d(i, o), this.ctx = o, this.setGState([
                                            ["BM", "source-over"],
                                            ["ca", 1],
                                            ["CA", 1]
                                    ...
                                    transform: function(e, t, r, s, n, i) {
                                        this.ctx.transform(e, t, r, s, n, i), this._cachedGetSinglePixelWidth = null
                                    },
                                    constructPath: function(e, t) {
                                        for (var r = this.ctx, n = this.current, i = n.x, a = n.y, o = 0, l = 0, c = e.length; o < c; o++) switch (0 | e[o]) {
                                    ...
                                    stroke: function(e) {
                                        ...
                                        if (t.globalAlpha = this.current.strokeAlpha, r && r.hasOwnProperty("type") && "Pattern" === r.type) {
                                            ...
                                            const e = t.mozCurrentTransform,
                                                n = s.Util.singularValueDecompose2dScale(e)[0];
                                            t.strokeStyle = r.getPattern(t, this), t.lineWidth = Math.max(this.getSinglePixelWidth() * a, this.current.lineWidth * n), t.stroke(), t.restore()
                                    ...
                                    endText: function() {
                                        ...
                                        if (void 0 !== e) {
                                            ...
                                            for (var r = 0; r < e.length; r++) {
                                                var s = e[r];
                                                t.setTransform.apply(t, s.transform), t.translate(s.x, s.y), s.addToPath(t, s.fontSize)
                                            }
                                    ...
                                    setTextMatrix: function(e, t, r, s, n, i) {
                                        this.current.textMatrix = [e, t, r, s, n, i], this.current.textMatrixScale = Math.sqrt(e * e + t * t), this.current.x = this.current.lineX = 0, this.current.y = this.current.lineY = 0
                                    },
                                    nextLine: function() {
                                    ...
                                    paintChar(e, t, r, n) {
                                        var i = this.ctx,
                                            ...
                                            h = l & s.TextRenderingMode.FILL_STROKE_MASK,
                                            d = !!(l & s.TextRenderingMode.ADD_TO_PATH_FLAG);
                                        const u = a.patternFill && o.data;
                                        var p;
                                        (o.disableFontFace || d || u) && (p = o.getPathGenerator(this.commonObjs, e)), o.disableFontFace || u ? (i.save(), i.translate(t, r), i.beginPath(), p(i, c), n && i.setTransform.apply(i, n), h !== s.TextRenderingMode.FILL && h !== s.TextRenderingMode.FILL_STROKE || i.fill(), h !== s.TextRenderingMode.STROKE && h !== s.TextRenderingMode.FILL_STROKE || i.stroke(), i.restore()) : (h !== s.TextRenderingMode.FILL && h !== s.TextRenderingMode.FILL_STROKE || i.fillText(e, t, r), h !== s.TextRenderingMode.STROKE && h !== s.TextRenderingMode.FILL_STROKE || i.strokeText(e, t, r)), d && (this.pendingTextPaths || (this.pendingTextPaths = [])).push({
                                    ...
                                    showText: function(e) {
                                        ...
                                        var i = this.ctx,
                                            ...
                                            f = r.defaultVMetrics,
                                            m = n * t.fontMatrix[0],
                                            A = t.textRenderingMode === s.TextRenderingMode.FILL && !r.disableFontFace && !t.patternFill;
                                        let b;
                                        if (i.save(), t.patternFill) {
                                            i.save();
                                            const e = t.fillColor.getPattern(i, this);
                                            b = i.mozCurrentTransform, i.restore(), i.fillStyle = e
                                        }
                                        i.transform.apply(i, t.textMatrix), i.translate(t.x, t.y + t.textRise), h > 0 ? i.scale(d, -1) : i.scale(d, 1);
                                        var _ = t.lineWidth,
                                            y = t.textMatrixScale;
                                        if (0 === y || 0 === _) {
                                            var v = t.textRenderingMode & s.TextRenderingMode.FILL_STROKE_MASK;
                                            v !== s.TextRenderingMode.STROKE && v !== s.TextRenderingMode.FILL_STROKE || (this._cachedGetSinglePixelWidth = null, _ = this.getSinglePixelWidth() * a)
                                        } else _ /= y;
                                        ...
                                        for (S = 0; S < u; ++S) {
                                            ...
                                            if ((0, s.isNum)(C)) x += g * C * n / 1e3;
                                                ...
                                                var k, w, R, P, T, E, F, L = !1,
                                                    I = (C.isSpace ? c : 0) + l,
                                                    M = C.fontChar,
                                                    D = C.accent,
                                                    O = C.width;
                                                if (p ? (T = C.vmetric || f, E = -(E = C.vmetric ? T[1] : .5 * O) * m, F = T[2] * m, O = T ? -T[0] : O, k = E / o, w = (x + F) / o) : (k = x / o, w = 0), r.remeasure && O > 0) {
                                                    var N = 1e3 * i.measureText(M).width / n * o;
                                                    if (O < N && this.isFontSubpixelAAEnabled) {
                                                        var j = O / N;
                                                        L = !0, i.save(), i.scale(j, 1), k /= j
                                                    } else O !== N && (k += (O - N) / 2e3 * n / o)
                                                }(C.isInFont || r.missingFile) && (A && !D ? i.fillText(M, k, w) : (this.paintChar(M, k, w, b), D && (R = k + D.offset.x / o, P = w - D.offset.y / o, this.paintChar(D.fontChar, R, P, b)))), x += p ? O * m - I * h : O * m + I * h, L && i.restore()
                                            }
                                        }
                                        p ? t.y -= x : t.x += x * d, i.restore()
                                    },
                                    showType3Text: function(e) {
                                        var t, r, n, i, a = this.ctx,
                                            o = this.current,
                                            l = o.font,
                                            c = o.fontSize,
                                            h = o.fontDirection,
                                            ...
                                            p = o.wordSpacing,
                                            g = o.textHScale * h,
                                            f = o.fontMatrix || s.FONT_IDENTITY_MATRIX,
                                            m = e.length;
                                        if (o.textRenderingMode !== s.TextRenderingMode.INVISIBLE && 0 !== c) {
                                            for (this._cachedGetSinglePixelWidth = null, a.save(), a.transform.apply(a, o.textMatrix), a.translate(o.x, o.y), a.scale(g, h), t = 0; t < m; ++t)
                                                if (r = e[t], (0, s.isNum)(r)) i = d * r * c / 1e3, this.ctx.translate(i, 0), o.x += i * g;
                                                else {
                                                    var A = (r.isSpace ? p : 0) + u,
                                                        b = l.charProcOperatorList[r.operatorListId];
                                                    b ? (this.processingType3 = r, this.save(), a.scale(c, c), a.transform.apply(a, f), this.executeOperatorList(b), this.restore(), n = s.Util.applyTransform([r.width, 0], f)[0] * c + A, a.translate(n, 0), o.x += n * g) : (0, s.warn)(`Type3 character "${r.operatorListId}" is not available.`)
                                                } a.restore(), this.processingType3 = null
                                        }
                                    },
                                    setCharWidth: function(e, t) {},
                                    setCharWidthAndBounds: function(e, t, r, s, n, i) {
                                        this.ctx.rect(r, s, n - r, i - s), this.clip(), this.endPath()
                                    },
                                    getColorN_Pattern: function(t) {
                                        ...
                                        if ("TilingPattern" === t[0]) {
                                            ...
                                            r = new n.TilingPattern(t, s, this.ctx, a, i)
                                        } else r = (0, n.getShadingPatternFromIR)(t);
                                        return r
                                    },
                                    ...
                                    shadingFill: function(e) {
                                        ...
                                        if (i) {
                                            var a = t.canvas,
                                                o = a.width,
                                                l = a.height,
                                                c = s.Util.applyTransform([0, 0], i),
                                                h = s.Util.applyTransform([0, l], i),
                                                d = s.Util.applyTransform([o, 0], i),
                                                u = s.Util.applyTransform([o, l], i),
                                                p = Math.min(c[0], h[0], d[0], u[0]),
                                                g = Math.min(c[1], h[1], d[1], u[1]),
                                                f = Math.max(c[0], h[0], d[0], u[0]),
                                                m = Math.max(c[1], h[1], d[1], u[1]);
                                            this.ctx.fillRect(p, g, f - p, m - g)
                                    ...
                                    paintFormXObjectBegin: function(e, t) {
                                        if (this.save(), this.baseTransformStack.push(this.baseTransform), Array.isArray(e) && 6 === e.length && this.transform.apply(this, e), this.baseTransform = this.ctx.mozCurrentTransform, t) {
                                            var r = t[2] - t[0],
                                                s = t[3] - t[1];
                                            this.ctx.rect(t[0], t[1], r, s), this.clip(), this.endPath()
                                        }
                                    },
                                    ...
                                    beginGroup: function(e) {
                                        ...
                                        var n = s.Util.getAxialAlignedBoundingBox(e.bbox, t.mozCurrentTransform),
                                            a = [0, 0, t.canvas.width, t.canvas.height];
                                        n = s.Util.intersect(n, a) || [0, 0, 0, 0];
                                        var o = Math.floor(n[0]),
                                            l = Math.floor(n[1]),
                                            c = Math.max(Math.ceil(n[2]) - o, 1),
                                        ...
                                        var f = this.cachedCanvases.getCanvas(g, c, h, !0),
                                            m = f.context;
                                        m.scale(1 / u, 1 / p), m.translate(-o, -l), m.transform.apply(m, r), e.smask ? this.smaskStack.push({
                                            canvas: f.canvas,
                                            context: m,
                                            offsetX: o,
                                            offsetY: l,
                                        ...
                                        }) : (t.setTransform(1, 0, 0, 1, 0, 0), t.translate(o, l), t.scale(u, p)), d(t, m), this.ctx = m, this.setGState([
                                            ["BM", "source-over"],
                                            ["ca", 1],
                                            ["CA", 1]
                                    ...
                                    beginAnnotation: function(e, t, r) {
                                        if (this.save(), u(this.ctx), this.current = new h, Array.isArray(e) && 4 === e.length) {
                                            var s = e[2] - e[0],
                                                n = e[3] - e[1];
                                            this.ctx.rect(e[0], e[1], s, n), this.clip(), this.endPath()
                                        }
                                    ...
                                    paintJpegXObject: function(e, t, r) {
                                        const n = this.processingType3 ? this.commonObjs.get(e) : this.objs.get(e);
                                        if (n) {
                                            this.save();
                                            var i = this.ctx;
                                            ...
                                            this.restore()
                                        } else(0, s.warn)("Dependent image isn't ready yet")
                                    },
                                    paintImageMaskXObject: function(e) {
                                        ...
                                        if (o && void 0 === o.compiled && (o.compiled = s <= 1e3 && n <= 1e3 ? function(e) {
                                                var t, r, s, n, i = e.width,
                                                    a = e.height,
                                                    o = i + 1,
                                                    ...
                                                    h = i + 7 & -8,
                                                    d = e.data,
                                                    u = new Uint8Array(h * a),
                                                    p = 0;
                                                for (t = 0, n = d.length; t < n; t++)
                                                    for (var g = 128, f = d[t]; g > 0;) u[p++] = f & g ? 0 : 255, g >>= 1;
                                                var m = 0;
                                                for (0 !== u[p = 0] && (l[0] = 1, ++m), r = 1; r < i; r++) u[p] !== u[p + 1] && (l[r] = u[p] ? 2 : 1, ++m), p++;
                                                for (0 !== u[p] && (l[r] = 2, ++m), t = 1; t < a; t++) {
                                                    s = t * o, u[(p = t * h) - h] !== u[p] && (l[s] = u[p] ? 1 : 8, ++m);
                                                    var A = (u[p] ? 4 : 0) + (u[p - h] ? 8 : 0);
                                                    for (r = 1; r < i; r++) c[A = (A >> 2) + (u[p + 1] ? 4 : 0) + (u[p - h + 1] ? 8 : 0)] && (l[s + r] = c[A], ++m), p++;
                                                    if (u[p - h] !== u[p] && (l[s + r] = u[p] ? 2 : 4, ++m), m > 1e3) return null
                                                }
                                                for (s = t * o, 0 !== u[p = h * (a - 1)] && (l[s] = 8, ++m), r = 1; r < i; r++) u[p] !== u[p + 1] && (l[s + r] = u[p] ? 4 : 8, ++m), p++;
                                                if (0 !== u[p] && (l[s + r] = 4, ++m), m > 1e3) return null;
                                                var b = new Int32Array([0, o, -1, 0, -o, 0, 0, 0, 1]),
                                                    _ = [];
                                                for (t = 0; m && t <= a; t++) {
                                                    for (var y = t * o, v = y + i; y < v && !l[y];) y++;
                                                    if (y !== v) {
                                                        var S, x = [y % o, t],
                                                            C = l[y],
                                                            k = y;
                                                        do {
                                                            ...
                                                            5 !== (S = l[y]) && 10 !== S ? (C = S, l[y] = 0) : (C = S & 51 * C >> 4, l[y] &= C >> 2 | C << 2), x.push(y % o), x.push(y / o | 0), l[y] || --m
                                                        } while (k !== y);
                                                        _.push(x), --t
                                                    }
                                                }
                                                return function(e) {
                                                    ...
                                                    for (var t = 0, r = _.length; t < r; t++) {
                                                        var s = _[t];
                                                        e.moveTo(s[0], s[1]);
                                                        for (var n = 2, o = s.length; n < o; n += 2) e.lineTo(s[n], s[n + 1])
                                                    }
                                            ...
                                            var l = this.cachedCanvases.getCanvas("maskCanvas", s, n),
                                                c = l.context;
                                            c.save(), r(c, e), c.globalCompositeOperation = "source-in", c.fillStyle = a ? i.getPattern(c, this) : i, c.fillRect(0, 0, s, n), c.restore(), this.paintInlineImageXObject(l.canvas)
                                        }
                                    },
                                    paintImageMaskXObjectRepeat: function(e, t, s, n) {
                                        var i = e.width,
                                            a = e.height,
                                        ...
                                        for (var d = this.ctx, u = 0, p = n.length; u < p; u += 2) d.save(), d.transform(t, 0, 0, s, n[u], n[u + 1]), d.scale(1, -1), d.drawImage(c.canvas, 0, 0, i, a, 0, -1, 1, 1), d.restore()
                                    },
                                    paintImageMaskXObjectGroup: function(e) {
                                        for (var t = this.ctx, s = this.current.fillColor, n = this.current.patternFill, i = 0, a = e.length; i < a; i++) {
                                            var o = e[i],
                                                l = o.width,
                                                c = o.height,
                                                h = this.cachedCanvases.getCanvas("maskCanvas", l, c),
                                                d = h.context;
                                            d.save(), r(d, o), d.globalCompositeOperation = "source-in", d.fillStyle = n ? s.getPattern(d, this) : s, d.fillRect(0, 0, l, c), d.restore(), t.save(), t.transform.apply(t, o.transform), t.scale(1, -1), t.drawImage(h.canvas, 0, 0, l, c, 0, -1, 1, 1), t.restore()
                                        }
                                    },
                                    paintImageXObject: function(e) {
                                        const t = this.processingType3 ? this.commonObjs.get(e) : this.objs.get(e);
                                        t ? this.paintInlineImageXObject(t) : (0, s.warn)("Dependent image isn't ready yet")
                                    },
                                    paintImageXObjectRepeat: function(e, t, r, n) {
                                        const i = this.processingType3 ? this.commonObjs.get(e) : this.objs.get(e);
                                        if (i) {
                                            for (var a = i.width, o = i.height, l = [], c = 0, h = n.length; c < h; c += 2) l.push({
                                    ...
                                    paintInlineImageXObject: function(e) {
                                        ...
                                        var i, a, o = n.mozCurrentTransformInverse,
                                            l = o[0],
                                            c = o[1],
                                            h = Math.max(Math.sqrt(l * l + c * c), 1),
                                            d = o[2],
                                            u = o[3],
                                            p = Math.max(Math.sqrt(d * d + u * u), 1);
                                        if ("function" == typeof HTMLElement && e instanceof HTMLElement || !e.data) i = e;
                                        else {
                                            var g = (a = this.cachedCanvases.getCanvas("inlineImage", r, s)).context;
                                            t(g, e), i = a.canvas
                                        }
                                        for (var f = r, m = s, A = "prescale1"; h > 2 && f > 1 || p > 2 && m > 1;) {
                                            var b = f,
                                                _ = m;
                                            h > 2 && f > 1 && (h /= f / (b = Math.ceil(f / 2))), p > 2 && m > 1 && (p /= m / (_ = Math.ceil(m / 2))), (g = (a = this.cachedCanvases.getCanvas(A, b, _)).context).clearRect(0, 0, b, _), g.drawImage(i, 0, 0, f, m, 0, 0, b, _), i = a.canvas, f = b, m = _, A = "prescale1" === A ? "prescale2" : "prescale1"
                                        }
                                        if (n.drawImage(i, 0, 0, f, m, 0, -s, r, s), this.imageLayer) {
                                            var y = this.getCanvasPosition(0, -s);
                                            this.imageLayer.appendImage({
                                                imgData: e,
                                                left: y[0],
                                                top: y[1],
                                    ...
                                    paintInlineImageXObjectGroup: function(e, r) {
                                        ...
                                        for (var o = 0, l = r.length; o < l; o++) {
                                            var c = r[o];
                                            if (s.save(), s.transform.apply(s, c.transform), s.scale(1, -1), s.drawImage(a.canvas, c.x, c.y, c.w, c.h, 0, -1, 1, 1), this.imageLayer) {
                                    ...
                                    consumePath: function() {
                                        var e = this.ctx;
                                        this.pendingClip && (this.pendingClip === y ? e.clip("evenodd") : e.clip(), this.pendingClip = null), e.beginPath()
                                    },
                                ...
                                }, s.OPS) e.prototype[s.OPS[v]] = e.prototype[v];
                            return e
                        }();
                    t.CanvasGraphics = d
                }, function(e, t, r) {
                    ...
                    var a = function() {
                        function e(e, t, r, s, n, i, a, o) {
                            ...
                            var p = (c[r] + t.offsetX) * t.scaleX,
                                ...
                                f = (c[s] + t.offsetX) * t.scaleX,
                                m = (c[s + 1] + t.offsetY) * t.scaleY,
                                A = (c[n] + t.offsetX) * t.scaleX,
                                b = (c[n + 1] + t.offsetY) * t.scaleY;
                            if (!(g >= b))
                                for (var _, y, v, S, x, C, k, w, R = h[i], P = h[i + 1], T = h[i + 2], E = h[a], F = h[a + 1], L = h[a + 2], I = h[o], M = h[o + 1], D = h[o + 2], O = Math.round(g), N = Math.round(b), j = O; j <= N; j++) {
                                    if (j < m) {
                                        let e;
                                        e = j < g ? 0 : g === m ? 1 : (g - j) / (g - m), _ = p - (p - f) * e, y = R - (R - E) * e, v = P - (P - F) * e, S = T - (T - L) * e
                                    } else {
                                        let e;
                                        e = j > b ? 1 : m === b ? 0 : (m - j) / (m - b), _ = f - (f - A) * e, y = E - (E - I) * e, v = F - (F - M) * e, S = L - (L - D) * e
                                    }
                                    let e;
                                    e = j < g ? 0 : j > b ? 1 : (g - j) / (g - b), x = p - (p - A) * e, C = R - (R - I) * e, k = P - (P - M) * e, w = T - (T - D) * e;
                                    for (var U = Math.round(Math.min(_, x)), q = Math.round(Math.max(_, x)), W = u * j + 4 * U, G = U; G <= q; G++) {
                                        let e = (_ - G) / (_ - x);
                                        e < 0 ? e = 0 : e > 1 && (e = 1), d[W++] = y - (y - C) * e | 0, d[W++] = v - (v - k) * e | 0, d[W++] = S - (S - w) * e | 0, d[W++] = 255
                                    }
                                }
                        }
                            ...
                            switch (r.type) {
                                case "lattice":
                                    var l = r.verticesPerRow,
                                        ...
                                        h = l - 1;
                                    for (n = 0; n < c; n++)
                                        for (var d = n * l, u = 0; u < h; u++, d++) e(t, s, a[d], a[d + 1], a[d + l], o[d], o[d + 1], o[d + l]), e(t, s, a[d + l + 1], a[d + 1], a[d + l], o[d + l + 1], o[d + 1], o[d + l]);
                                    break;
                                case "triangles":
                                    for (n = 0, i = a.length; n < i; n += 3) e(t, s, a[n], a[n + 1], a[n + 2], o[n], o[n + 1], o[n + 2]);
                                    break;
                                default:
                                    throw new Error("illegal figure")
                            }
                        }
                        return function(e, r, s, n, i, a, o, l) {
                            var c, h, d, u, p = Math.floor(e[0]),
                                g = Math.floor(e[1]),
                                f = Math.ceil(e[2]) - p,
                                m = Math.ceil(e[3]) - g,
                                A = Math.min(Math.ceil(Math.abs(f * r[0] * 1.1)), 3e3),
                                b = Math.min(Math.ceil(Math.abs(m * r[1] * 1.1)), 3e3),
                                _ = f / A,
                                y = m / b,
                                v = {
                                    coords: s,
                            ...
                            if (l.isEnabled) c = l.drawFigures({
                                ...
                                figures: i,
                                context: v
                            }), (h = o.getCanvas("mesh", S, x, !1)).context.drawImage(c, 2, 2), c = h.canvas;
                            else {
                                var C = (h = o.getCanvas("mesh", S, x, !1)).context,
                                    k = C.createImageData(A, b);
                                if (a) {
                                    var w = k.data;
                                    for (d = 0, u = w.length; d < u; d += 4) w[d] = a[0], w[d + 1] = a[1], w[d + 2] = a[2], w[d + 3] = 255
                                }
                                for (d = 0; d < i.length; d++) t(k, i[d], v);
                                C.putImageData(k, 2, 2), c = h.canvas
                            }
                            return {
                                canvas: c,
                                offsetX: p - 2 * _,
                    ...
                    n.Mesh = {
                        fromIR: function(e) {
                            ...
                            return {
                                type: "Pattern",
                                getPattern: function(e, d, u) {
                                    var p;
                                    if (i(e, c), u) p = s.Util.singularValueDecompose2dScale(e.mozCurrentTransform);
                                    else if (p = s.Util.singularValueDecompose2dScale(d.baseTransform), l) {
                                        var g = s.Util.singularValueDecompose2dScale(l);
                                        p = [p[0] * g[0], p[1] * g[1]]
                                    }
                                    var f = a(o, p, t, r, n, u ? null : h, d.cachedCanvases, d.webGLContext);
                                    return u || (e.setTransform.apply(e, d.baseTransform), l && e.transform.apply(e, l)), e.translate(f.offsetX, f.offsetY), e.scale(f.scaleX, f.scaleY), e.createPattern(f.canvas, "no-repeat")
                                }
                            }
                        }
                    }, n.Dummy = {
                    ...
                    var o = function() {
                        ...
                        function r(e, t, r, s, n) {
                            this.operatorList = e[2], this.matrix = e[3] || [1, 0, 0, 1, 0, 0], this.bbox = e[4], this.xstep = e[5], this.ystep = e[6], this.paintType = e[7], this.tilingType = e[8], this.color = t, this.canvasGraphicsFactory = s, this.baseTransform = n, this.type = "Pattern", this.ctx = r
                        }
                        return r.prototype = {
                            createPatternCanvas: function(e) {
                                ...
                                var h = r[0],
                                    ...
                                    b = this.getSizeAndScale(i, this.ctx.canvas.height, m[1]),
                                    _ = e.cachedCanvases.getCanvas("pattern", A.size, b.size, !0),
                                    y = _.context,
                                    v = c.createCanvasGraphics(y);
                                return v.groupLevel = e.groupLevel, this.setFillAndStrokeStyleToContext(v, a, l), v.transform(A.scale, 0, 0, b.scale, 0, 0), v.transform(1, 0, 0, 1, -h, -d), this.clipBbox(v, r, h, d, u, p), v.executeOperatorList(t), this.ctx.transform(1, 0, 0, 1, h, d), this.ctx.scale(1 / A.scale, 1 / b.scale), _.canvas
                            },
                            getSizeAndScale: function(e, t, r) {
                                e = Math.abs(e);
                                var s = Math.max(3e3, t),
                                    n = Math.ceil(e * r);
                                return n >= s ? n = s : r = n / e, {
                                    scale: r,
                                    size: n
                                }
                            },
                            clipBbox: function(e, t, r, s, n, i) {
                                if (Array.isArray(t) && 4 === t.length) {
                                    var a = n - r,
                                        o = i - s;
                                    e.ctx.rect(r, s, a, o), e.clip(), e.endPath()
                                }
                            },
                            setFillAndStrokeStyleToContext: function(r, n, i) {
                                const a = r.ctx,
                                    o = r.current;
                                switch (n) {
                                    case e:
                                        ...
                                        break;
                                    case t:
                                        var c = s.Util.makeCssRgb(i[0], i[1], i[2]);
                                        a.fillStyle = c, a.strokeStyle = c, o.fillColor = c, o.strokeColor = c;
                                        break;
                                    default:
                                        throw new s.FormatError(`Unsupported paint type: ${n}`)
                                }
                            },
                    ...
                    const s = Object.create(null);
                    t.GlobalWorkerOptions = s, s.workerPort = void 0 === s.workerPort ? null : s.workerPort, s.workerSrc = void 0 === s.workerSrc ? "" : s.workerSrc
                }, function(e, t, r) {
                    "use strict";
                    Object.defineProperty(t, "__esModule", {
                        value: !0
                    ...
                    t.MessageHandler = class {
                        ...
                        sendWithStream(e, t, r, n) {
                            ...
                            return new ReadableStream({
                                start: r => {
                                    const a = (0, s.createPromiseCapability)();
                                ...
                                cancel: e => {
                                    (0, s.assert)(e instanceof Error, "cancel must have a valid reason");
                                    const t = (0, s.createPromiseCapability)();
                        ...
                        _createStreamSink(e) {
                            const t = this,
                                ...
                                d = {
                                    enqueue(e, r = 1, o) {
                                        ...
                                        this.desiredSize -= r, l > 0 && this.desiredSize <= 0 && (this.sinkCapability = (0, s.createPromiseCapability)(), this.ready = this.sinkCapability.promise), t._postMessage({
                                            sourceName: i,
                                            targetName: a,
                                            stream: c,
                                            streamId: n,
                                    ...
                                    error(e) {
                                        (0, s.assert)(e instanceof Error, "error must have a valid reason"), this.isCancelled || (this.isCancelled = !0, o.postMessage({
                                            sourceName: i,
                                            targetName: a,
                                            stream: h,
                                            streamId: n,
                            ...
                            d.sinkCapability.resolve(), d.ready = d.sinkCapability.promise, this.streamSinks[n] = d, new Promise((function(t) {
                                t(r(e.data, d))
                            })).then((function() {
                                o.postMessage({
                                    sourceName: i,
                        ...
                        _processStreamMessage(e) {
                            ...
                            switch (e.stream) {
                                case p:
                                    e.success ? this.streamControllers[t].startCall.resolve() : this.streamControllers[t].startCall.reject(g(e.reason));
                                    break;
                                case u:
                                    e.success ? this.streamControllers[t].pullCall.resolve() : this.streamControllers[t].pullCall.reject(g(e.reason));
                                    break;
                                case d:
                                    ...
                                    break;
                                case c:
                                    if ((0, s.assert)(this.streamControllers[t], "enqueue should have stream controller"), this.streamControllers[t].isClosed) break;
                                    this.streamControllers[t].controller.enqueue(e.chunk);
                                    break;
                                case l:
                                    if ((0, s.assert)(this.streamControllers[t], "close should have stream controller"), this.streamControllers[t].isClosed) break;
                                    this.streamControllers[t].isClosed = !0, this.streamControllers[t].controller.close(), this._deleteStreamController(t);
                                    break;
                                case h:
                                    (0, s.assert)(this.streamControllers[t], "error should have stream controller"), this.streamControllers[t].controller.error(g(e.reason)), this._deleteStreamController(t);
                                    break;
                                case o:
                                    e.success ? this.streamControllers[t].cancelCall.resolve() : this.streamControllers[t].cancelCall.reject(g(e.reason)), this._deleteStreamController(t);
                                    break;
                                case a:
                                    ...
                                    })), this.streamSinks[t].sinkCapability.reject(g(e.reason)), this.streamSinks[t].isCancelled = !0, delete this.streamSinks[t];
                                    break;
                                default:
                    ...
                    t.Metadata = class {
                        constructor(e) {
                            (0, s.assert)("string" == typeof e, "Metadata: input is not a string"), e = this._repair(e);
                        ...
                        _repair(e) {
                            return e.replace(/^[^<]+/, "").replace(/>\\376\\377([^<]+)/g, (function(e, t) {
                                const r = t.replace(/\\([0-3])([0-7])([0-7])/g, (function(e, t, r, s) {
                                    return String.fromCharCode(64 * t + 8 * r + 1 * s)
                                ...
                                for (let e = 0, t = r.length; e < t; e += 2) {
                                    ...
                                    s += t >= 32 && t < 127 && 60 !== t && 62 !== t && 38 !== t ? String.fromCharCode(t) : "&#x" + (65536 + t).toString(16).substring(1) + ";"
                                }
                                return ">" + s
                            }))
                        }
                                ...
                                if ("rdf:description" === t.nodeName.toLowerCase())
                                    for (let e = 0, r = t.childNodes.length; e < r; e++)
                                        if ("#text" !== t.childNodes[e].nodeName.toLowerCase()) {
                                            ...
                                            this._metadataMap.set(s, r.textContent.trim())
                                        }
                            }
                        }
                        get(e) {
                    ...
                    t.SimpleXMLParser = class extends class {
                        ...
                        _parseContent(e, t) {
                            ...
                            function n() {
                                for (; s < e.length && h(e, s);) ++s
                            }
                            for (; s < e.length && !h(e, s) && ">" !== e[s] && "/" !== e[s];) ++s;
                            const i = e.substring(t, s);
                            for (n(); s < e.length && ">" !== e[s] && "/" !== e[s] && "?" !== e[s];) {
                                n();
                                let t = "",
                                    i = "";
                                    ...
                                    switch (++r, e[r]) {
                                        ...
                                        case "!":
                                            if ("--" === e.substring(r + 1, r + 3)) {
                                                ...
                                                if (t = e.indexOf("]]>", r + 8), t < 0) return void this.onError(n);
                                                ...
                                                if ("DOCTYPE" !== e.substring(r + 1, r + 8)) return void this.onError(l); {
                                                    ...
                                                    const i = e.substring(r + 8, t + (n ? 1 : 0));
                                                    this.onDoctype(i), r = t + (n ? 2 : 1)
                                                }
                                            }
                                            break;
                                        default:
                                            ...
                                            this.onBeginElement(h.name, h.attributes, d), r += h.parsed + (d ? 2 : 1)
                                    }
                                } else {
                        ...
                        constructor() {
                            super(), this._currentFragment = null, this._stack = null, this._errorCode = s
                        }
                        parseFromString(e) {
                            if (this._currentFragment = [], this._stack = [], this._errorCode = s, this.parseXml(e), this._errorCode !== s) return;
                        ...
                        onBeginElement(e, t, r) {
                            const s = new d(e);
                            s.childNodes = [], this._currentFragment.push(s), r || (this._stack.push(this._currentFragment), this._currentFragment = s.childNodes)
                        }
                        onEndElement(e) {
                    ...
                    t.PDFDataTransportStream = class {
                        constructor(e, t) {
                            (0, s.assert)(t), this._queuedChunks = [], this._progressiveDone = e.progressiveDone || !1;
                        ...
                        getFullReader() {
                            ...
                            return this._queuedChunks = null, new n(this, e, this._progressiveDone)
                        }
                        getRangeReader(e, t) {
                    ...
                    t.WebGLContext = class {
                        ...
                        get isEnabled() {
                            let e = this._enabled;
                            return e && (e = n.tryInitGL()), (0, s.shadow)(this, "isEnabled", e)
                        }
                        composeSMask({
                            layer: e,
                            mask: t,
                        ...
                        drawFigures({
                            ...
                            return n.drawFigures(e, t, r, s, i)
                        }
                        clear() {
                            n.cleanup()
                        }
                    ...
                    var n = function() {
                        function e(e, t, r) {
                            ...
                            if (e.shaderSource(s, t), e.compileShader(s), !e.getShaderParameter(s, e.COMPILE_STATUS)) {
                                var n = e.getShaderInfoLog(s);
                                throw new Error("Error during shader compilation: " + n)
                            }
                            return s
                        }
                        ...
                        function s(e, t) {
                            for (var r = e.createProgram(), s = 0, n = t.length; s < n; ++s) e.attachShader(r, t[s]);
                        ...
                        return {
                            ...
                            composeSMask: function(e, c, h) {
                                ...
                                l || function() {
                                    ...
                                    var d = n.getAttribLocation(c, "a_texCoord"),
                                        u = n.getUniformLocation(c, "u_image"),
                                        p = n.getUniformLocation(c, "u_mask"),
                                        g = n.createBuffer();
                                ...
                                var m = n(f, e, f.TEXTURE0),
                                    A = n(f, c, f.TEXTURE1),
                                    b = f.createBuffer();
                                return f.bindBuffer(f.ARRAY_BUFFER, b), f.bufferData(f.ARRAY_BUFFER, new Float32Array([0, 0, d, 0, 0, u, 0, u, d, 0, d, u]), f.STATIC_DRAW), f.enableVertexAttribArray(p.positionLocation), f.vertexAttribPointer(p.positionLocation, 2, f.FLOAT, !1, 0, 0), f.clearColor(0, 0, 0, 0), f.enable(f.BLEND), f.blendFunc(f.ONE, f.ONE_MINUS_SRC_ALPHA), f.clear(f.COLOR_BUFFER_BIT), f.drawArrays(f.TRIANGLES, 0, 6), f.flush(), f.deleteTexture(m), f.deleteTexture(A), f.deleteBuffer(b), g
                            },
                            drawFigures: function(e, n, l, h, d) {
                                c || function() {
                                    var e, n;
                                    o(), e = a, a = null, n = i, i = null;
                                ...
                                var f, m, A, b = 0;
                                for (f = 0, m = h.length; f < m; f++) switch (h[f].type) {
                                    case "lattice":
                                        b += ((A = h[f].coords.length / h[f].verticesPerRow | 0) - 1) * (h[f].verticesPerRow - 1) * 6;
                                        break;
                                    case "triangles":
                                        b += h[f].coords.length
                                }
                                var _ = new Float32Array(2 * b),
                                    y = new Uint8Array(3 * b),
                                    v = d.coords,
                                    S = d.colors,
                                    x = 0,
                                    C = 0;
                                for (f = 0, m = h.length; f < m; f++) {
                                    ...
                                    switch (k.type) {
                                        case "lattice":
                                            var P = k.verticesPerRow;
                                            A = w.length / P | 0;
                                            for (var T = 1; T < A; T++)
                                                for (var E = T * P + 1, F = 1; F < P; F++, E++) _[x] = v[w[E - P - 1]], _[x + 1] = v[w[E - P - 1] + 1], _[x + 2] = v[w[E - P]], _[x + 3] = v[w[E - P] + 1], _[x + 4] = v[w[E - 1]], _[x + 5] = v[w[E - 1] + 1], y[C] = S[R[E - P - 1]], y[C + 1] = S[R[E - P - 1] + 1], y[C + 2] = S[R[E - P - 1] + 2], y[C + 3] = S[R[E - P]], y[C + 4] = S[R[E - P] + 1], y[C + 5] = S[R[E - P] + 2], y[C + 6] = S[R[E - 1]], y[C + 7] = S[R[E - 1] + 1], y[C + 8] = S[R[E - 1] + 2], _[x + 6] = _[x + 2], _[x + 7] = _[x + 3], _[x + 8] = _[x + 4], _[x + 9] = _[x + 5], _[x + 10] = v[w[E]], _[x + 11] = v[w[E] + 1], y[C + 9] = y[C + 3], y[C + 10] = y[C + 4], y[C + 11] = y[C + 5], y[C + 12] = y[C + 6], y[C + 13] = y[C + 7], y[C + 14] = y[C + 8], y[C + 15] = S[R[E]], y[C + 16] = S[R[E] + 1], y[C + 17] = S[R[E] + 2], x += 12, C += 18;
                                            break;
                                        case "triangles":
                                            for (var L = 0, I = w.length; L < I; L++) _[x] = v[w[L]], _[x + 1] = v[w[L] + 1], y[C] = S[R[L]], y[C + 1] = S[R[L] + 1], y[C + 2] = S[R[L] + 2], x += 2, C += 3
                                    }
                                }
                                l ? g.clearColor(l[0] / 255, l[1] / 255, l[2] / 255, 1) : g.clearColor(0, 0, 0, 0), g.clear(g.COLOR_BUFFER_BIT);
                                ...
                                var D = g.createBuffer();
                                return g.bindBuffer(g.ARRAY_BUFFER, D), g.bufferData(g.ARRAY_BUFFER, y, g.STATIC_DRAW), g.enableVertexAttribArray(u.colorLocation), g.vertexAttribPointer(u.colorLocation, 3, g.UNSIGNED_BYTE, !1, 0, 0), g.uniform2f(u.scaleLocation, d.scaleX, d.scaleY), g.uniform2f(u.offsetLocation, d.offsetX, d.offsetY), g.drawArrays(g.TRIANGLES, 0, b), g.flush(), g.deleteBuffer(M), g.deleteBuffer(D), p
                            },
                            cleanup() {
                    ...
                    var s = r(1),
                        n = function() {
                            ...
                            function t(t, r, n) {
                                ...
                                var l = s.Util.transform(t._viewport.transform, r.transform),
                            ...
                            function r(e) {
                                if (!e._canceled) {
                                    ...
                                    if (!e._textContentStream)
                                        for (var n = 0; n < s; n++) e._layoutText(t[n]);
                            ...
                            function n(e) {
                                for (var t = e._bounds, r = e._viewport, n = function(e, t, r) {
                                        ...
                                        })), i(t, s), s.forEach((function(e) {
                                            var t = e.index;
                                            n[t].top = e.x1New, n[t].bottom = e.x2New
                                        })), n
                                    }(r.width, r.height, t), a = 0; a < n.length; a++) {
                                    var o = t[a].div,
                                        l = e._textDivProperties.get(o);
                                    if (0 !== l.angle) {
                                        var c = n[a],
                                            h = t[a],
                                            d = h.m,
                                        ...
                                        g.forEach((function(e, t) {
                                            var r = s.Util.applyTransform(e, d);
                                            f[t + 0] = u && (c.left - r[0]) / u, f[t + 4] = p && (c.top - r[1]) / p, f[t + 8] = u && (c.right - r[0]) / u, f[t + 12] = p && (c.bottom - r[1]) / p, f[t + 16] = p && (c.left - r[0]) / -p, f[t + 20] = u && (c.top - r[1]) / u, f[t + 24] = p && (c.right - r[0]) / -p, f[t + 28] = u && (c.bottom - r[1]) / u, f[t + 32] = u && (c.left - r[0]) / -u, f[t + 36] = p && (c.top - r[1]) / -p, f[t + 40] = u && (c.right - r[0]) / -u, f[t + 44] = p && (c.bottom - r[1]) / -p, f[t + 48] = p && (c.left - r[0]) / p, f[t + 52] = u && (c.top - r[1]) / -u, f[t + 56] = p && (c.right - r[0]) / p, f[t + 60] = u && (c.bottom - r[1]) / -u
                                        }));
                                        var m = function(e, t, r) {
                                                for (var s = 0, n = 0; n < r; n++) {
                                                    var i = e[t++];
                                                    i > 0 && (s = s ? Math.min(i, s) : i)
                                                }
                                                return s
                                            },
                                            A = 1 + Math.min(Math.abs(u), Math.abs(p));
                                        l.paddingLeft = m(f, 32, 16) / A, l.paddingTop = m(f, 48, 16) / A, l.paddingRight = m(f, 0, 16) / A, l.paddingBottom = m(f, 16, 16) / A, e._textDivProperties.set(o, l)
                                    } else l.paddingLeft = t[a].left - n[a].left, l.paddingTop = t[a].top - n[a].top, l.paddingRight = n[a].right - t[a].right, l.paddingBottom = n[a].bottom - t[a].bottom, e._textDivProperties.set(o, l)
                                }
                            }
                            ...
                            function i(e, t) {
                                ...
                                t.forEach((function(e) {
                                    ...
                                    for (a = t; a <= i; a++) {
                                        var c;
                                        (c = (n = (s = r[a]).boundary).x2 > e.x1 ? n.index > e.index ? n.x1New : e.x1 : void 0 === n.x2New ? (n.x2 + e.x1) / 2 : n.x2New) > l && (l = c)
                                    }
                                    for (e.x1New = l, a = t; a <= i; a++) void 0 === (n = (s = r[a]).boundary).x2New ? n.x2 > e.x1 ? n.index > e.index && (n.x2New = n.x2) : n.x2New = l : n.x2New > l && (n.x2New = Math.max(l, n.x2));
                                    var h = [],
                                        d = null;
                                    for (a = t; a <= i; a++) {
                                        var u = (n = (s = r[a]).boundary).x2 > e.x2 ? n : e;
                                        d === u ? h[h.length - 1].end = s.end : (h.push({
                                            start: s.start,
                                            end: s.end,
                                            boundary: u
                                        }), d = u)
                                    ...
                                    for (r[t].start < e.y1 && (h[0].start = e.y1, h.unshift({
                                        ...
                                        if (void 0 === (n = (s = r[a]).boundary).x2New) {
                                            var p = !1;
                            ...
                            return a.prototype = {
                                    ...
                                    cancel: function() {
                                        this._canceled = !0, this._reader && (this._reader.cancel(new s.AbortException("TextLayer task cancelled.")), this._reader = null), null !== this._renderTimer && (clearTimeout(this._renderTimer), this._renderTimer = null), this._capability.reject(new Error("TextLayer task cancelled."))
                                    },
                                    _processItems(e, r) {
                                        for (let s = 0, n = e.length; s < n; s++) this._textContentItemsStr.push(e[s].str), t(this, e[s], r)
                                    },
                                    _layoutText(e) {
                                    ...
                                    _render: function(e) {
                                            ...
                                            if (!this._textContentStream) throw new Error('Neither "textContent" nor "textContentStream" parameters specified.'); {
                                                const e = () => {
                                                    this._reader.read().then((({
                                                        ...
                                                        s ? t.resolve() : (Object.assign(n, r.styles), this._processItems(r.items, n), e())
                                                    }), t.reject)
                                                };
                                        ...
                                        t.promise.then((() => {
                                            n = null, e ? this._renderTimer = setTimeout((() => {
                                ...
                                case n.AnnotationType.WIDGET:
                                    switch (e.data.fieldType) {
                                        case "Tx":
                                            return new h(e);
                                        case "Btn":
                                            return e.data.radioButton ? new u(e) : e.data.checkBox ? new d(e) : new p(e);
                                        case "Ch":
                                            return new g(e)
                                    }
                                    return new c(e);
                    ...
                    class a {
                        ...
                        _createContainer(e = !1) {
                            ...
                            if (i.style.transform = `matrix(${s.transform.join(",")})`, i.style.transformOrigin = `-${l[0]}px -${l[1]}px`, !e && t.borderStyle.width > 0) {
                                i.style.borderWidth = `${t.borderStyle.width}px`, t.borderStyle.style !== n.AnnotationBorderStyleType.UNDERLINE && (a -= 2 * t.borderStyle.width, o -= 2 * t.borderStyle.width);
                                ...
                                t.color ? i.style.borderColor = n.Util.makeCssRgb(0 | t.color[0], 0 | t.color[1], 0 | t.color[2]) : i.style.borderWidth = 0
                            }
                        ...
                        _createPopup(e, t, r) {
                            ...
                            s.style.left = e.style.width, e.appendChild(s)
                        }
                        render() {
                    ...
                    class o extends a {
                        ...
                        render() {
                            ...
                            return e.url ? (0, s.addLinkAttributes)(r, {
                                url: e.url,
                    ...
                    class f extends a {
                        ...
                        render() {
                            ...
                            const r = new m({
                                ...
                                n = parseFloat(t.style.width);
                            return this.container.style.transformOrigin = `-${s+n}px -${t.style.top}`, this.container.style.left = `${s+n}px`, this.container.appendChild(r.render()), this.container
                        }
                    }
                    class m {
                        constructor(e) {
                        ...
                        render() {
                            ...
                            if (r) {
                                const e = .7 * (255 - r[0]) + r[0],
                                    s = .7 * (255 - r[1]) + r[1],
                                    i = .7 * (255 - r[2]) + r[2];
                                t.style.backgroundColor = n.Util.makeCssRgb(0 | e, 0 | s, 0 | i)
                            }
                        ...
                        _formatContents(e) {
                            ...
                            for (let e = 0, s = r.length; e < s; ++e) {
                                const n = r[e];
                                t.appendChild(document.createTextNode(n)), e < s - 1 && t.appendChild(document.createElement("br"))
                            }
                            return t
                        }
                        _toggle() {
                    ...
                    class _ extends a {
                        ...
                        render() {
                            ...
                            return i.setAttribute("x", n / 2), i.setAttribute("y", n / 2), i.setAttribute("width", t - n), i.setAttribute("height", r - n), i.setAttribute("stroke-width", n || 1), i.setAttribute("stroke", "transparent"), i.setAttribute("fill", "none"), s.appendChild(i), this.container.append(s), this._createPopup(this.container, i, e), this.container
                        }
                    }
                    class y extends a {
                        constructor(e) {
                        ...
                        render() {
                            ...
                            return i.setAttribute("cx", t / 2), i.setAttribute("cy", r / 2), i.setAttribute("rx", t / 2 - n / 2), i.setAttribute("ry", r / 2 - n / 2), i.setAttribute("stroke-width", n || 1), i.setAttribute("stroke", "transparent"), i.setAttribute("fill", "none"), s.appendChild(i), this.container.append(s), this._createPopup(this.container, i, e), this.container
                        }
                    }
                    class v extends a {
                        constructor(e) {
                        ...
                        render() {
                            ...
                            return i.setAttribute("points", n), i.setAttribute("stroke-width", e.borderStyle.width || 1), i.setAttribute("stroke", "transparent"), i.setAttribute("fill", "none"), s.appendChild(i), this.container.append(s), this._createPopup(this.container, i, e), this.container
                        }
                    }
                    class S extends v {
                        constructor(e) {
                    ...
                    class C extends a {
                        ...
                        render() {
                            ...
                            for (const t of e.inkLists) {
                                ...
                                n.setAttribute("points", r), n.setAttribute("stroke-width", e.borderStyle.width || 1), n.setAttribute("stroke", "transparent"), n.setAttribute("fill", "none"), this._createPopup(this.container, n, e), s.appendChild(n)
                            }
                    ...
                    class E extends a {
                        constructor(e) {
                            ...
                            this.filename = (0, s.getFilenameFromUrl)(t), this.content = r, this.linkService.eventBus && this.linkService.eventBus.dispatch("fileattachmentannotation", {
                                source: this,
                        ...
                        _download() {
                            this.downloadManager ? this.downloadManager.downloadData(this.content, this.filename, "") : (0, n.warn)("Download cannot be started due to unavailable download manager")
                        }
                    }
                    ...
                    t.SVGGraphics = a; {
                        const e = {
                            ...
                            u = function() {
                                ...
                                function r(e, r, s, n) {
                                    ...
                                    s[i] = o >> 24 & 255, s[i + 1] = o >> 16 & 255, s[i + 2] = o >> 8 & 255, s[i + 3] = 255 & o
                                }
                                ...
                                function a(t, a, o, l) {
                                    ...
                                    const b = new Uint8Array([c >> 24 & 255, c >> 16 & 255, c >> 8 & 255, 255 & c, h >> 24 & 255, h >> 16 & 255, h >> 8 & 255, 255 & h, d, u, 0, 0, 0]),
                                        _ = function(e) {
                                            if (!i.isNodeJS) return n(e);
                                            try {
                                                let t;
                                        ...
                                        y = e.length + 36 + b.length + _.length,
                                        v = new Uint8Array(y);
                                    let S = 0;
                                    return v.set(e, S), S += e.length, r("IHDR", b, v, S), S += 12 + b.length, r("IDATA", _, v, S), S += 12 + _.length, r("IEND", new Uint8Array(0), v, S), (0, s.createObjectURL)(v, "image/png", o)
                                }
                                return function(e, t, r) {
                                    return a(e, void 0 === e.kind ? s.ImageKind.GRAYSCALE_1BPP : e.kind, t, r)
                                }
                            }();
                        class p {
                            constructor() {
                                this.fontSizeScale = 1, this.fontWeight = e.fontWeight, this.fontSize = 0, this.textMatrix = s.IDENTITY_MATRIX, this.fontMatrix = s.FONT_IDENTITY_MATRIX, this.leading = 0, this.textRenderingMode = s.TextRenderingMode.FILL, this.textMatrixScale = 1, this.x = 0, this.y = 0, this.lineX = 0, this.lineY = 0, this.charSpacing = 0, this.wordSpacing = 0, this.textHScale = 1, this.textRise = 0, this.fillColor = e.fillColor, this.strokeColor = "#000000", this.fillAlpha = 1, this.strokeAlpha = 1, this.lineWidth = 1, this.lineJoin = "", this.lineCap = "", this.miterLimit = 0, this.dashArray = [], this.dashPhase = 0, this.dependencies = [], this.activeClipUrl = null, this.clipGroup = null, this.maskId = ""
                            }
                            clone() {
                                return Object.create(this)
                            }
                        ...
                        function l(e) {
                            if (0 === e[4] && 0 === e[5]) {
                                if (0 === e[1] && 0 === e[2]) return 1 === e[0] && 1 === e[3] ? "" : `scale(${o(e[0])} ${o(e[3])})`;
                                if (e[0] === e[3] && e[1] === -e[2]) return `rotate(${o(180*Math.acos(e[0])/Math.PI)})`
                            } else if (1 === e[0] && 0 === e[1] && 0 === e[2] && 1 === e[3]) return `translate(${o(e[4])} ${o(e[5])})`;
                            return `matrix(${o(e[0])} ${o(e[1])} ${o(e[2])} ${o(e[3])} ${o(e[4])} ${o(e[5])})`
                        }
                        let g = 0,
                            f = 0,
                            m = 0;
                        t.SVGGraphics = a = class {
                            ...
                            transform(e, t, r, n, i, a) {
                                const o = [e, t, r, n, i, a];
                                this.transformMatrix = s.Util.transform(this.transformMatrix, o), this.tgrp = null
                            }
                            getSVG(e, t) {
                                this.viewport = t;
                            ...
                            convertOpList(e) {
                                ...
                                return function(e) {
                                    let t = [];
                                    const r = [];
                                    for (const s of e) "save" !== s.fn ? "restore" === s.fn ? t = r.pop() : t.push(s) : (t.push({
                                        fnId: 92,
                                        fn: "group",
                                        items: []
                                ...
                                for (const t of e) {
                                    ...
                                    switch (0 | r) {
                                        ...
                                        case s.OPS.paintJpegXObject:
                                            this.paintJpegXObject(n[0], n[1], n[2]);
                                            break;
                            ...
                            setTextMatrix(e, t, r, s, n, i) {
                                const a = this.current;
                                a.textMatrix = a.lineMatrix = [e, t, r, s, n, i], a.textMatrixScale = Math.sqrt(e * e + t * t), a.x = a.lineX = 0, a.y = a.lineY = 0, a.xcoords = [], a.tspan = this.svgFactory.createElement("svg:tspan"), a.tspan.setAttributeNS(null, "font-family", a.fontFamily), a.tspan.setAttributeNS(null, "font-size", `${o(a.fontSize)}px`), a.tspan.setAttributeNS(null, "y", o(-a.y)), a.txtElement = this.svgFactory.createElement("svg:text"), a.txtElement.appendChild(a.tspan)
                            }
                            beginText() {
                                const e = this.current;
                                e.x = e.lineX = 0, e.y = e.lineY = 0, e.textMatrix = s.IDENTITY_MATRIX, e.lineMatrix = s.IDENTITY_MATRIX, e.textMatrixScale = 1, e.tspan = this.svgFactory.createElement("svg:tspan"), e.txtElement = this.svgFactory.createElement("svg:text"), e.txtgrp = this.svgFactory.createElement("svg:g"), e.xcoords = []
                            }
                            moveText(e, t) {
                                const r = this.current;
                                r.x = r.lineX += e, r.y = r.lineY += t, r.xcoords = [], r.tspan = this.svgFactory.createElement("svg:tspan"), r.tspan.setAttributeNS(null, "font-family", r.fontFamily), r.tspan.setAttributeNS(null, "font-size", `${o(r.fontSize)}px`), r.tspan.setAttributeNS(null, "y", o(-r.y))
                            }
                            showText(t) {
                                ...
                                for (const e of t) {
                                    ...
                                    const t = e.width,
                                        r = e.fontChar,
                                        o = t * g + ((e.isSpace ? h : 0) + c) * d;
                                    e.isInFont || i.missingFile ? (n.xcoords.push(n.x + f), n.tspan.textContent += r, f += o) : f += o
                                }
                                p ? n.y -= f * u : n.x += f * u, n.tspan.setAttributeNS(null, "x", n.xcoords.map(o).join(" ")), n.tspan.setAttributeNS(null, "y", o(-n.y)), n.tspan.setAttributeNS(null, "font-family", n.fontFamily), n.tspan.setAttributeNS(null, "font-size", `${o(n.fontSize)}px`), n.fontStyle !== e.fontStyle && n.tspan.setAttributeNS(null, "font-style", n.fontStyle), n.fontWeight !== e.fontWeight && n.tspan.setAttributeNS(null, "font-weight", n.fontWeight);
                                const m = n.textRenderingMode & s.TextRenderingMode.FILL_STROKE_MASK;
                                if (m === s.TextRenderingMode.FILL || m === s.TextRenderingMode.FILL_STROKE ? (n.fillColor !== e.fillColor && n.tspan.setAttributeNS(null, "fill", n.fillColor), n.fillAlpha < 1 && n.tspan.setAttributeNS(null, "fill-opacity", n.fillAlpha)) : n.textRenderingMode === s.TextRenderingMode.ADD_TO_PATH ? n.tspan.setAttributeNS(null, "fill", "transparent") : n.tspan.setAttributeNS(null, "fill", "none"), m === s.TextRenderingMode.STROKE || m === s.TextRenderingMode.FILL_STROKE) {
                                    const e = 1 / (n.textMatrixScale || 1);
                                    this._setStrokeAttributes(n.tspan, e)
                                }
                                let A = n.textMatrix;
                                0 !== n.textRise && (A = A.slice(), A[5] += n.textRise), n.txtElement.setAttributeNS(null, "transform", `${l(A)} scale(${o(u)}, -1)`), n.txtElement.setAttributeNS(r, "xml:space", "preserve"), n.txtElement.appendChild(n.tspan), n.txtgrp.appendChild(n.txtElement), this._ensureTransformGroup().appendChild(n.txtElement)
                            }
                            ...
                            setFont(e) {
                                ...
                                let n = e[1];
                                t.font = r, this.embedFonts && r.data && !this.embeddedFonts[r.loadedName] && (this.addFontStyle(r), this.embeddedFonts[r.loadedName] = r), t.fontMatrix = r.fontMatrix ? r.fontMatrix : s.FONT_IDENTITY_MATRIX;
                                let i = "normal";
                                r.black ? i = "900" : r.bold && (i = "bold");
                                const a = r.italic ? "italic" : "normal";
                                n < 0 ? (n = -n, t.fontDirection = -1) : t.fontDirection = 1, t.fontSize = n, t.fontFamily = r.loadedName, t.fontWeight = i, t.fontStyle = a, t.tspan = this.svgFactory.createElement("svg:tspan"), t.tspan.setAttributeNS(null, "y", o(-t.y)), t.xcoords = []
                            }
                            endText() {
                                const e = this.current;
                                e.textRenderingMode & s.TextRenderingMode.ADD_TO_PATH_FLAG && e.txtElement && e.txtElement.hasChildNodes() && (e.element = e.txtElement, this.clip("nonzero"), this.endPath())
                            }
                            setLineWidth(e) {
                            ...
                            setStrokeRGBColor(e, t, r) {
                                this.current.strokeColor = s.Util.makeCssRgb(e, t, r)
                            }
                            setFillAlpha(e) {
                                this.current.fillAlpha = e
                            }
                            setFillRGBColor(e, t, r) {
                                this.current.fillColor = s.Util.makeCssRgb(e, t, r), this.current.tspan = this.svgFactory.createElement("svg:tspan"), this.current.xcoords = []
                            }
                            setStrokeColorN(e) {
                            ...
                            shadingFill(e) {
                                const t = this.viewport.width,
                                    ...
                                    a = s.Util.applyTransform([0, r], n),
                                    o = s.Util.applyTransform([t, 0], n),
                                    l = s.Util.applyTransform([t, r], n),
                                    c = Math.min(i[0], a[0], o[0], l[0]),
                                    h = Math.min(i[1], a[1], o[1], l[1]),
                                    d = Math.max(i[0], a[0], o[0], l[0]),
                                    u = Math.max(i[1], a[1], o[1], l[1]),
                                    p = this.svgFactory.createElement("svg:rect");
                                p.setAttributeNS(null, "x", c), p.setAttributeNS(null, "y", h), p.setAttributeNS(null, "width", d - c), p.setAttributeNS(null, "height", u - h), p.setAttributeNS(null, "fill", this._makeShadingPattern(e)), this._ensureTransformGroup().appendChild(p)
                            }
                            ...
                            _makeTilingPattern(e) {
                                const t = e[1],
                                    ...
                                    d = e[7],
                                    u = "shading" + m++,
                                    [p, g] = s.Util.applyTransform([i, a], n),
                                    [f, A] = s.Util.applyTransform([o, l], n),
                                    [b, _] = s.Util.singularValueDecompose2dScale(n),
                                    y = c * b,
                                    v = h * _,
                                ...
                                const x = this.svg,
                                    ...
                                    R = this.svgFactory.create(f - p, A - g);
                                if (this.svg = R, this.transformMatrix = n, 2 === d) {
                                    const e = s.Util.makeCssRgb(...t);
                                    this.current.fillColor = e, this.current.strokeColor = e
                                }
                                return this.executeOpTree(this.convertOpList(r)), this.svg = x, this.transformMatrix = C, this.current.fillColor = k, this.current.strokeColor = w, S.appendChild(R.childNodes[0]), this.defs.appendChild(S), `url(#${u})`
                            }
                                ...
                                switch (e[0]) {
                                    case "RadialAxial":
                                        ...
                                        for (const e of r) {
                                            ...
                                            t.setAttributeNS(null, "offset", e[0]), t.setAttributeNS(null, "stop-color", e[1]), n.appendChild(t)
                                        }
                            ...
                            constructPath(e, t) {
                                ...
                                for (const r of e) switch (0 | r) {
                                    case s.OPS.rectangle:
                                        ...
                                        break;
                                    case s.OPS.moveTo:
                                        n = t[l++], i = t[l++], a.push("M", o(n), o(i));
                                        break;
                                    case s.OPS.lineTo:
                                        n = t[l++], i = t[l++], a.push("L", o(n), o(i));
                                        break;
                                    case s.OPS.curveTo:
                                        n = t[l + 4], i = t[l + 5], a.push("C", o(t[l]), o(t[l + 1]), o(t[l + 2]), o(t[l + 3]), o(n), o(i)), l += 6;
                                        break;
                                    case s.OPS.curveTo2:
                                        a.push("C", o(n), o(i), o(t[l]), o(t[l + 1]), o(t[l + 2]), o(t[l + 3])), n = t[l + 2], i = t[l + 3], l += 4;
                                        break;
                                    case s.OPS.curveTo3:
                                        n = t[l + 2], i = t[l + 3], a.push("C", o(t[l]), o(t[l + 1]), o(n), o(i), o(n), o(i)), l += 4;
                                        break;
                                    case s.OPS.closePath:
                                        a.push("Z")
                                }
                                a = a.join(" "), r.path && e.length > 0 && e[0] !== s.OPS.rectangle && e[0] !== s.OPS.moveTo ? a = r.path.getAttributeNS(null, "d") + a : (r.path = this.svgFactory.createElement("svg:path"), this._ensureTransformGroup().appendChild(r.path)), r.path.setAttributeNS(null, "d", a), r.path.setAttributeNS(null, "fill", "none"), r.element = r.path, r.setCurrentPoint(n, i)
                            }
                            endPath() {
                                const e = this.current;
                                ...
                                "evenodd" === this.pendingClip ? s.setAttributeNS(null, "clip-rule", "evenodd") : s.setAttributeNS(null, "clip-rule", "nonzero"), this.pendingClip = null, r.appendChild(s), this.defs.appendChild(r), e.activeClipUrl && (e.clipGroup = null, this.extraStack.forEach((function(e) {
                                    e.clipGroup = null
                            ...
                            _setStrokeAttributes(e, t = 1) {
                                ...
                                1 !== t && s.length > 0 && (s = s.map((function(e) {
                                    return t * e
                                }))), e.setAttributeNS(null, "stroke", r.strokeColor), e.setAttributeNS(null, "stroke-opacity", r.strokeAlpha), e.setAttributeNS(null, "stroke-miterlimit", o(r.miterLimit)), e.setAttributeNS(null, "stroke-linecap", r.lineCap), e.setAttributeNS(null, "stroke-linejoin", r.lineJoin), e.setAttributeNS(null, "stroke-width", o(t * r.lineWidth) + "px"), e.setAttributeNS(null, "stroke-dasharray", s.map(o).join(" ")), e.setAttributeNS(null, "stroke-dashoffset", o(t * r.dashPhase) + "px")
                            }
                            eoFill() {
                            ...
                            paintJpegXObject(e, t, r) {
                                const s = this.objs.get(e),
                                    n = this.svgFactory.createElement("svg:image");
                                n.setAttributeNS(c, "xlink:href", s.src), n.setAttributeNS(null, "width", o(t)), n.setAttributeNS(null, "height", o(r)), n.setAttributeNS(null, "x", "0"), n.setAttributeNS(null, "y", o(-r)), n.setAttributeNS(null, "transform", `scale(${o(1/t)} ${o(-1/r)})`), this._ensureTransformGroup().appendChild(n)
                            }
                            paintImageXObject(e) {
                                const t = this.objs.get(e);
                                t ? this.paintInlineImageXObject(t) : (0, s.warn)(`Dependent image with object ID ${e} is not ready yet`)
                            }
                            paintInlineImageXObject(e, t) {
                                const r = e.width,
                                    s = e.height,
                                    n = u(e, this.forceDataSchema, !!t),
                                    i = this.svgFactory.createElement("svg:rect");
                                ...
                                a.setAttributeNS(c, "xlink:href", n), a.setAttributeNS(null, "x", "0"), a.setAttributeNS(null, "y", o(-s)), a.setAttributeNS(null, "width", o(r) + "px"), a.setAttributeNS(null, "height", o(s) + "px"), a.setAttributeNS(null, "transform", `scale(${o(1/r)} ${o(-1/s)})`), t ? t.appendChild(a) : this._ensureTransformGroup().appendChild(a)
                            }
                            paintImageMaskXObject(e) {
                                ...
                                a.setAttributeNS(null, "x", "0"), a.setAttributeNS(null, "y", "0"), a.setAttributeNS(null, "width", o(r)), a.setAttributeNS(null, "height", o(s)), a.setAttributeNS(null, "fill", n), a.setAttributeNS(null, "mask", `url(#${t.maskId})`), this.defs.appendChild(i), this._ensureTransformGroup().appendChild(a), this.paintInlineImageXObject(e, i)
                            }
                            paintFormXObjectBegin(e, t) {
                                if (Array.isArray(e) && 6 === e.length && this.transform(e[0], e[1], e[2], e[3], e[4], e[5]), t) {
                                    ...
                                    s.setAttributeNS(null, "x", t[0]), s.setAttributeNS(null, "y", t[1]), s.setAttributeNS(null, "width", o(e)), s.setAttributeNS(null, "height", o(r)), this.current.element = s, this.clip("nonzero"), this.endPath()
                                }
                            }
                            paintFormXObjectEnd() {}
                            _initialize(e) {
                                ...
                                return s.setAttributeNS(null, "transform", l(e.transform)), t.appendChild(s), this.svg = s, t
                            }
                            _ensureClipGroup() {
                            ...
                            _ensureTransformGroup() {
                                return this.tgrp || (this.tgrp = this.svgFactory.createElement("svg:g"), this.tgrp.setAttributeNS(null, "transform", l(this.transformMatrix)), this.current.activeClipUrl ? this._ensureClipGroup().appendChild(this.tgrp) : this.svg.appendChild(this.tgrp)), this.tgrp
                            }
                        }
                    }
                }, function(e, t, r) {
                    ...
                    t.PDFNodeStream = class {
                        ...
                        getFullReader() {
                            return (0, s.assert)(!this._fullRequestReader), this._fullRequestReader = this.isFsUrl ? new f(this) : new p(this), this._fullRequestReader
                        }
                        getRangeReader(e, t) {
                            if (t <= this._progressiveDataLength) return null;
                    ...
                    class h {
                        constructor(e) {
                            ...
                            const t = e.source;
                            this._contentLength = t.length, this._loaded = 0, this._filename = null, this._disableRange = t.disableRange || !1, this._rangeChunkSize = t.rangeChunkSize, this._rangeChunkSize || this._disableRange || (this._disableRange = !0), this._isStreamingSupported = !t.disableStream, this._isRangeSupported = !t.disableRange, this._readableStream = null, this._readCapability = (0, s.createPromiseCapability)(), this._headersCapability = (0, s.createPromiseCapability)()
                        }
                        get headersReady() {
                        ...
                        async read() {
                            ...
                            return null === e ? (this._readCapability = (0, s.createPromiseCapability)(), this.read()) : (this._loaded += e.length, this.onProgress && this.onProgress({
                                loaded: this._loaded,
                    ...
                    class d {
                        constructor(e) {
                            this._url = e.url, this._done = !1, this._storedError = null, this.onProgress = null, this._loaded = 0, this._readableStream = null, this._readCapability = (0, s.createPromiseCapability)();
                            const t = e.source;
                    ...
                    class p extends h {
                        constructor(e) {
                            ...
                            this._request = null, "http:" === this._url.protocol ? this._request = a.request(u(this._url, e.httpHeaders), t) : this._request = o.request(u(this._url, e.httpHeaders), t), this._request.on("error", (e => {
                    ...
                    class g extends d {
                        constructor(e, t, r) {
                            ...
                            this._request = null, "http:" === this._url.protocol ? this._request = a.request(u(this._url, this._httpHeaders), n) : this._request = o.request(u(this._url, this._httpHeaders), n), this._request.on("error", (e => {
                                this._storedError = e
                            })), this._request.end()
                        }
                    }
                    class f extends h {
                        constructor(e) {
                            ...
                            c.test(this._url.href) && (t = t.replace(/^\//, "")), i.lstat(t, ((e, r) => {
                                if (e) return "ENOENT" === e.code && (e = new s.MissingPDFException(`Missing PDF "${t}".`)), this._storedError = e, void this._headersCapability.reject(e);
                    ...
                    class m extends d {
                        constructor(e, t, r) {
                            ...
                            c.test(this._url.href) && (s = s.replace(/^\//, "")), this._setReadableStream(i.createReadStream(s, {
                                start: t,
                                end: r - 1
                            }))
                        }
                    ...
                    Object.defineProperty(t, "__esModule", {
                        ...
                        return Number.isInteger(a) ? (i.suggestedLength = a, a <= 2 * r || n || !t || "bytes" !== e("Accept-Ranges") || "identity" !== (e("Content-Encoding") || "identity") || (i.allowRangeRequests = !0), i) : i
                    ...
                    Object.defineProperty(t, "__esModule", {
                        ...
                        if (r = function(e) {
                                ...
                                for (let e = 0; e < t.length && e in t; ++e) {
                                    let [r, s] = t[e];
                                    s = a(s), r && (s = unescape(s), 0 === e && (s = o(s))), i.push(s)
                                }
                                return i.join("")
                            }(e), r) return i(l(r));
                        if (r = s("filename", "i").exec(e), r) {
                            r = r[1];
                            let e = a(r);
                            return e = l(e), i(e)
                        }
                            ...
                            if (e) {
                                ...
                                try {
                                    const s = new TextDecoder(e, {
                                        ...
                                        n = Array.from(r, (function(e) {
                                            return 255 & e.charCodeAt(0)
                                        }));
                                    r = s.decode(new Uint8Array(n)), t = !1
                                } catch (s) {
                        ...
                        function i(e) {
                            return t && /[\x80-\xff]/.test(e) && (e = n("utf-8", e), t && (e = n("iso-8859-1", e))), e
                        }
                        ...
                        function o(e) {
                            const t = e.indexOf("'");
                            return -1 === t ? e : n(e.slice(0, t), e.slice(t + 1).replace(/^[^']*'/, ""))
                        }

                        function l(e) {
                            return !e.startsWith("=?") || /[\x00-\x19\x80-\xff]/.test(e) ? e : e.replace(/=\?([\w-]*)\?([QqBb])\?((?:[^?]|\?(?!=))*)\?=/g, (function(e, t, r, s) {
                                if ("q" === r || "Q" === r) return n(t, s = (s = s.replace(/_/g, " ")).replace(/=([0-9a-fA-F]{2})/g, (function(e, t) {
                    ...
                    class i {
                        ...
                        request(e) {
                            ...
                            return this.isHttp && "begin" in e && "end" in e ? (t.setRequestHeader("Range", `bytes=${e.begin}-${e.end-1}`), s.expectedStatus = 206) : s.expectedStatus = 200, t.responseType = "arraybuffer", e.onError && (t.onerror = function(r) {
                                e.onError(t.status)
                            }), t.onreadystatechange = this.onStateChange.bind(this, r), t.onprogress = this.onProgress.bind(this, r), s.onHeadersReceived = e.onHeadersReceived, s.onDone = e.onDone, s.onError = e.onError, s.onProgress = e.onProgress, t.send(null), r
                        }
                        onProgress(e, t) {
                        ...
                        onStateChange(e, t) {
                            ...
                            const a = function(e) {
                                const t = e.response;
                                return "string" != typeof t ? t : (0, s.stringToBytes)(t).buffer
                            }(n);
                            if (206 === i) {
                    ...
                    t.PDFNetworkStream = class {
                        ...
                        getFullReader() {
                            return (0, s.assert)(!this._fullRequestReader), this._fullRequestReader = new a(this._manager, this._source), this._fullRequestReader
                        }
                        getRangeReader(e, t) {
                    ...
                    class a {
                        ...
                        _onHeadersReceived() {
                            ...
                            s && (this._isRangeSupported = !0), this._contentLength = i || this._contentLength, this._filename = (0, n.extractFilenameFromHeader)(r), this._isRangeSupported && this._manager.abortRequest(e), this._headersReceivedCapability.resolve()
                        }
                        _onDone(e) {
                    ...
                    class o {
                        constructor(e, t, r) {
                            ...
                            this._requestId = e.requestRange(t, r, s), this._requests = [], this._queuedChunk = null, this._done = !1, this.onProgress = null, this.onClosed = null
                        }
                        _close() {
                    ...
                    t.PDFFetchStream = class {
                        ...
                        getFullReader() {
                            return (0, s.assert)(!this._fullRequestReader), this._fullRequestReader = new o(this), this._fullRequestReader
                        }
                        getRangeReader(e, t) {
                            if (t <= this._progressiveDataLength) return null;
                    ...
                    class o {
                        constructor(e) {
                            ...
                            fetch(r, i(this._headers, this._withCredentials, this._abortController)).then((e => {
                                if (!(0, n.validateResponseStatus)(e.status)) throw (0, n.createResponseStatusError)(e.status, r);
                                ...
                                this._isRangeSupported = i, this._contentLength = a || this._contentLength, this._filename = (0, n.extractFilenameFromHeader)(t), !this._isStreamingSupported && this._isRangeSupported && this.cancel(new s.AbortException("Streaming is disabled."))
                    ...
                    class l {
                        constructor(e, t, r) {
                            ...
                            fetch(l, i(this._headers, this._withCredentials, this._abortController)).then((e => {
                                if (!(0, n.validateResponseStatus)(e.status)) throw (0, n.createResponseStatusError)(e.status, l);
            ...
            }, "object" == typeof exports && "object" == typeof module ? module.exports = factory() : "function" == typeof define && define.amd ? define("pdfjs-dist/build/pdf", [], factory) : "object" == typeof exports ? exports["pdfjs-dist/build/pdf"] = factory() : root["pdfjs-dist/build/pdf"] = root.pdfjsLib = factory()
        }
    }
]);