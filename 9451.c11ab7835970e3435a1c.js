        ...
        27856: function(e) {
            e.exports = function() {
                ...
                function C() {
                    ...
                    if (i.version = "2.0.7", i.removed = [], !e || !e.document || 9 !== e.document.nodeType) return i.isSupported = !1, i;
                    var d = e.document,
                        f = !1,
                        p = !1,
                        h = e.document,
                        ...
                        P = e.NodeFilter,
                        F = e.NamedNodeMap,
                        I = void 0 === F ? e.NamedNodeMap || e.MozNamedAttrMap : F,
                        j = e.Text,
                        H = e.Comment,
                        z = e.DOMParser,
                        U = e.TrustedTypes;
                    ...
                    var K = g,
                        ...
                        Se = !1,
                        _e = {},
                        Me = m({}, ["annotation-xml", "audio", "colgroup", "desc", "foreignobject", "head", "iframe", "math", "mi", "mn", "mo", "ms", "mtext", "noembed", "noframes", "plaintext", "script", "style", "svg", "template", "thead", "title", "video", "xmp"]),
                        ke = m({}, ["audio", "video", "img", "source", "image"]),
                        Oe = null,
                        Le = m({}, ["alt", "class", "for", "id", "label", "name", "pattern", "placeholder", "summary", "title", "value", "style", "xmlns"]),
                        Ce = null,
                        Re = h.createElement("form"),
                        De = function(e) {
                            Ce && Ce === e || (e && "object" === (void 0 === e ? "undefined" : E(e)) || (e = {}), ae = "ALLOWED_TAGS" in e ? m({}, e.ALLOWED_TAGS) : ie, le = "ALLOWED_ATTR" in e ? m({}, e.ALLOWED_ATTR) : se, Oe = "ADD_URI_SAFE_ATTR" in e ? m(y(Le), e.ADD_URI_SAFE_ATTR) : Le, ue = "FORBID_TAGS" in e ? m({}, e.FORBID_TAGS) : {}, ce = "FORBID_ATTR" in e ? m({}, e.FORBID_ATTR) : {}, _e = "USE_PROFILES" in e && e.USE_PROFILES, de = !1 !== e.ALLOW_ARIA_ATTR, fe = !1 !== e.ALLOW_DATA_ATTR, pe = e.ALLOW_UNKNOWN_PROTOCOLS || !1, me = e.SAFE_FOR_JQUERY || !1, ye = e.SAFE_FOR_TEMPLATES || !1, he = e.WHOLE_DOCUMENT || !1, be = e.RETURN_DOM || !1, we = e.RETURN_DOM_FRAGMENT || !1, Te = e.RETURN_DOM_IMPORT || !1, Ae = e.RETURN_TRUSTED_TYPE || !1, ve = e.FORCE_BODY || !1, xe = !1 !== e.SANITIZE_DOM, Ee = !1 !== e.KEEP_CONTENT, Se = e.IN_PLACE || !1, oe = e.ALLOWED_URI_REGEXP || oe, ye && (fe = !1), we && (be = !0), _e && (ae = m({}, [].concat(S(a))), le = [], !0 === _e.html && (m(ae, t), m(le, l)), !0 === _e.svg && (m(ae, n), m(le, s), m(le, c)), !0 === _e.svgFilters && (m(ae, r), m(le, s), m(le, c)), !0 === _e.mathMl && (m(ae, o), m(le, u), m(le, c))), e.ADD_TAGS && (ae === ie && (ae = y(ae)), m(ae, e.ADD_TAGS)), e.ADD_ATTR && (le === se && (le = y(le)), m(le, e.ADD_ATTR)), e.ADD_URI_SAFE_ATTR && m(Oe, e.ADD_URI_SAFE_ATTR), Ee && (ae["#text"] = !0), he && m(ae, ["html", "head", "body"]), ae.table && (m(ae, ["tbody"]), delete ue.tbody), k && k(e), Ce = e)
                        },
                        Ne = function(e) {
                            i.removed.push({
                                element: e
                        ...
                        Fe = function(e) {
                            ...
                            return e && n && t.body.insertBefore(h.createTextNode(n), t.body.childNodes[0] || null), $.call(t, he ? "html" : "body")[0]
                        };
                    i.isSupported && (function() {
                        try {
                            Fe('<svg><p><textarea><img src="</textarea><img src=x abc=1//">').querySelector("svg img") && (f = !0)
                        } catch (e) {}
                    }(), function() {
                        try {
                            var e = Fe("<x/><title>&lt;/title&gt;&lt;img&gt;");
                            /<\/title/.test(e.querySelector("title").innerHTML) && (p = !0)
                        } catch (e) {}
                    }());
                    var Ie = function(e) {
                        ...
                        je = function(e) {
                            return !(e instanceof j || e instanceof H || "string" == typeof e.nodeName && "string" == typeof e.textContent && "function" == typeof e.removeChild && e.attributes instanceof I && "function" == typeof e.removeAttribute && "function" == typeof e.setAttribute && "string" == typeof e.namespaceURI)
                        },
                        He = function(e) {
                        ...
                        Ue = function(e) {
                            var t = void 0;
                            if (ze("beforeSanitizeElements", e, null), je(e)) return Ne(e), !0;
                            var n = e.nodeName.toLowerCase();
                            if (ze("uponSanitizeElement", e, {
                                    tagName: n,
                                    allowedTags: ae
                                }), ("svg" === n || "math" === n) && 0 !== e.querySelectorAll("p, br").length) return Ne(e), !0;
                            if (!ae[n] || ue[n]) {
                            ...
                            return "noscript" === n && /<\/noscript/i.test(e.innerHTML) || "noembed" === n && /<\/noembed/i.test(e.innerHTML) ? (Ne(e), !0) : (!me || e.firstElementChild || e.content && e.content.firstElementChild || !/</g.test(e.textContent) || (i.removed.push({
                                element: e.cloneNode()
                        ...
                        Ve = function(e, t, n) {
                            if (xe && ("id" === t || "name" === t) && (n in h || n in Re)) return !1;
                            if (fe && ee.test(t));
                        ...
                        qe = function(e) {
                            ...
                            if (l) {
                                ...
                                for (a = l.length; a--;) {
                                    ...
                                    if (s.keepAttr)
                                        if (/svg|math/i.test(e.namespaceURI) && new RegExp("</(" + Object.keys(Me).join("|") + ")", "i").test(n)) Pe(c, e);
                                        else {
                        ...
                        Be = function e(t) {
                            var n = void 0,
                                r = Ie(t);
                            for (ze("beforeSanitizeShadowDOM", t, null); n = r.nextNode();) ze("uponSanitizeShadowNode", n, null), Ue(n) || (n.content instanceof R && e(n.content), qe(n));
                    ...
                    return i.sanitize = function(t, n) {
                        ...
                        for (var u = Ie(Se ? t : r); a = u.nextNode();) 3 === a.nodeType && a === l || Ue(a) || (a.content instanceof R && Be(a.content), qe(a), l = a);
